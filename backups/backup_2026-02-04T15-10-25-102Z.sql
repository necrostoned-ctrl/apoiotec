...
\restrict uWAP5hXBiYawsWQ1oJqAvRygmAUjyibUqvPRwqb7WDlqfj19MntE1WpsLHx5GDc
...
ALTER TABLE IF EXISTS ONLY public.telegram_config DROP CONSTRAINT IF EXISTS telegram_config_pkey;
ALTER TABLE IF EXISTS ONLY public.system_settings DROP CONSTRAINT IF EXISTS system_settings_pkey;
ALTER TABLE IF EXISTS ONLY public.system_activation DROP CONSTRAINT IF EXISTS system_activation_pkey;
ALTER TABLE IF EXISTS ONLY public.system_activation DROP CONSTRAINT IF EXISTS system_activation_hardware_fingerprint_key;
ALTER TABLE IF EXISTS ONLY public.signature_audit_log DROP CONSTRAINT IF EXISTS signature_audit_log_pkey;
ALTER TABLE IF EXISTS ONLY public.signature_attempts DROP CONSTRAINT IF EXISTS signature_attempts_pkey;
ALTER TABLE IF EXISTS ONLY public.services DROP CONSTRAINT IF EXISTS services_pkey;
ALTER TABLE IF EXISTS ONLY public.quotes DROP CONSTRAINT IF EXISTS quotes_pkey;
ALTER TABLE IF EXISTS ONLY public.preventive_maintenance DROP CONSTRAINT IF EXISTS preventive_maintenance_pkey;
...
ALTER TABLE IF EXISTS ONLY public.inventory_services DROP CONSTRAINT IF EXISTS inventory_services_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_products DROP CONSTRAINT IF EXISTS inventory_products_pkey;
ALTER TABLE IF EXISTS ONLY public.inventory_movements DROP CONSTRAINT IF EXISTS inventory_movements_pkey;
ALTER TABLE IF EXISTS ONLY public.history_events DROP CONSTRAINT IF EXISTS history_events_pkey;
ALTER TABLE IF EXISTS ONLY public.financial_transactions DROP CONSTRAINT IF EXISTS financial_transactions_pkey;
ALTER TABLE IF EXISTS ONLY public.download_links DROP CONSTRAINT IF EXISTS download_links_pkey;
ALTER TABLE IF EXISTS ONLY public.digital_certificates DROP CONSTRAINT IF EXISTS digital_certificates_pkey;
ALTER TABLE IF EXISTS ONLY public.clients DROP CONSTRAINT IF EXISTS clients_pkey;
ALTER TABLE IF EXISTS ONLY public.client_notes DROP CONSTRAINT IF EXISTS client_notes_pkey;
...
ALTER TABLE IF EXISTS ONLY public.backup_history DROP CONSTRAINT IF EXISTS backup_history_pkey;
ALTER TABLE IF EXISTS ONLY public.backup_execution_logs DROP CONSTRAINT IF EXISTS backup_execution_logs_pkey;
...
ALTER TABLE IF EXISTS public.telegram_config ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.system_settings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.system_activation ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.signature_audit_log ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.signature_attempts ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.preventive_maintenance ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.inventory_services ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.inventory_products ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.inventory_movements ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.history_events ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.financial_transactions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.download_links ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.digital_certificates ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.clients ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.client_notes ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.backup_history ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.backup_execution_logs ALTER COLUMN id DROP DEFAULT;
...
DROP SEQUENCE IF EXISTS public.telegram_config_id_seq;
DROP TABLE IF EXISTS public.telegram_config;
DROP SEQUENCE IF EXISTS public.system_settings_id_seq;
DROP TABLE IF EXISTS public.system_settings;
DROP SEQUENCE IF EXISTS public.system_activation_id_seq;
DROP TABLE IF EXISTS public.system_activation;
DROP SEQUENCE IF EXISTS public.signature_audit_log_id_seq;
DROP TABLE IF EXISTS public.signature_audit_log;
DROP SEQUENCE IF EXISTS public.signature_attempts_id_seq;
DROP TABLE IF EXISTS public.signature_attempts;
DROP SEQUENCE IF EXISTS public.services_id_seq;
DROP TABLE IF EXISTS public.services;
DROP SEQUENCE IF EXISTS public.quotes_id_seq;
DROP TABLE IF EXISTS public.quotes;
DROP SEQUENCE IF EXISTS public.preventive_maintenance_id_seq;
DROP TABLE IF EXISTS public.preventive_maintenance;
...
DROP SEQUENCE IF EXISTS public.inventory_services_id_seq;
DROP TABLE IF EXISTS public.inventory_services;
DROP SEQUENCE IF EXISTS public.inventory_products_id_seq;
...
DROP SEQUENCE IF EXISTS public.history_events_id_seq;
...
DROP SEQUENCE IF EXISTS public.download_links_id_seq;
DROP TABLE IF EXISTS public.download_links;
DROP SEQUENCE IF EXISTS public.digital_certificates_id_seq;
DROP TABLE IF EXISTS public.digital_certificates;
DROP SEQUENCE IF EXISTS public.clients_id_seq;
DROP TABLE IF EXISTS public.clients;
DROP SEQUENCE IF EXISTS public.client_notes_id_seq;
...
DROP SEQUENCE IF EXISTS public.backup_history_id_seq;
DROP TABLE IF EXISTS public.backup_history;
DROP SEQUENCE IF EXISTS public.backup_execution_logs_id_seq;
DROP TABLE IF EXISTS public.backup_execution_logs;
...
--
-- Name: backup_execution_logs; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: backup_execution_logs_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: backup_execution_logs_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: digital_certificates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: digital_certificates_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: digital_certificates_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: download_links; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: history_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: history_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: history_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: inventory_products_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: inventory_products_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: inventory_services; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: inventory_services_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: inventory_services_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: preventive_maintenance; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: preventive_maintenance_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: preventive_maintenance_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: signature_attempts; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: signature_attempts_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: signature_attempts_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: system_activation; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: system_activation_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: system_activation_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: telegram_config_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: telegram_config_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: backup_execution_logs id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: digital_certificates id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: download_links id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: history_events id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: inventory_products id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: inventory_services id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: preventive_maintenance id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: signature_attempts id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: system_activation id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: telegram_config id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Data for Name: backup_execution_logs; Type: TABLE DATA; Schema: public; Owner: -
--
...
37	4	sucesso	2026-01-20 15:50:13.204	2026-01-20 15:50:13.204	620114	\N	t	2026-01-20 15:50:13.222707	\N	\N
38	4	sucesso	2026-01-21 15:50:35.739	2026-01-21 15:50:35.739	629160	\N	t	2026-01-21 15:50:35.954328	\N	\N
39	4	sucesso	2026-01-22 15:50:55.886	2026-01-22 15:50:55.886	635384	\N	t	2026-01-22 15:50:55.903453	\N	\N
40	4	sucesso	2026-01-26 21:20:53.337	2026-01-26 21:20:53.337	636680	\N	f	2026-01-26 21:20:53.338347	\N	\N
41	4	sucesso	2026-01-27 15:50:12.803	2026-01-27 15:50:12.803	636877	\N	f	2026-01-27 15:50:12.804989	\N	\N
42	4	sucesso	2026-01-28 15:50:15.907	2026-01-28 15:50:15.907	644407	\N	f	2026-01-28 15:50:15.908285	\N	\N
43	4	sucesso	2026-01-29 18:50:03.546	2026-01-29 18:50:03.546	670827	\N	t	2026-01-29 15:50:03.549344	\N	\N
44	4	sucesso	2026-01-30 18:51:00.425	2026-01-30 18:51:00.425	672346	\N	t	2026-01-30 15:51:00.429838	\N	\N
45	4	sucesso	2026-01-31 18:50:01.682	2026-01-31 18:50:01.682	674113	\N	t	2026-01-31 15:50:01.687365	\N	\N
46	4	sucesso	2026-02-01 18:50:03.45	2026-02-01 18:50:03.45	676642	\N	t	2026-02-01 15:50:03.455341	\N	\N
47	4	sucesso	2026-02-02 18:50:04.29	2026-02-02 18:50:04.29	680070	\N	t	2026-02-02 15:50:04.293071	\N	\N
48	4	sucesso	2026-02-04 05:00:05.844	2026-02-04 05:00:05.844	694983	\N	t	2026-02-04 02:00:05.847727	\N	\N
\.
...
63	backup_scheduled_2026-01-22T15-50-38-184Z.sql	635384	sucesso	2026-01-22 15:51:01.803925	Backup automático - diario	f	f	\N
64	backup_2026-01-23T04-10-03-400Z.sql	642009	sucesso	2026-01-26 21:08:02.414265	Restaurado com sucesso - ativação preservada	f	f	\N
65	backup_2026-01-26T21-21-04-777Z.sql	639641	sucesso	2026-01-26 21:21:04.929006	\N	f	f	\N
66	backup_scheduled_2026-01-27T15-50-11-104Z.sql	636877	sucesso	2026-01-27 15:50:13.012364	Backup automático - diario	f	f	\N
67	backup_scheduled_2026-01-28T15-50-14-182Z.sql	644407	sucesso	2026-01-28 15:50:15.960165	Backup automático - diario	f	f	\N
68	backup_2026-01-28T19-21-33-634Z.sql	653853	sucesso	2026-01-28 19:21:33.782218	\N	f	f	\N
69	backup_2026-01-28T19-22-16-498Z.sql	653944	sucesso	2026-01-28 16:22:49.271913	Restaurado com sucesso - ativação preservada	f	f	\N
70	backup_scheduled_2026-01-29T18-50-02-927Z.sql	670827	sucesso	2026-01-29 15:50:09.8801	Backup automático - diario	f	f	\N
71	backup_scheduled_2026-01-30T18-50-59-806Z.sql	672346	sucesso	2026-01-30 15:51:04.976324	Backup automático - diario	f	f	\N
72	backup_scheduled_2026-01-31T18-50-01-066Z.sql	674113	sucesso	2026-01-31 15:50:06.05074	Backup automático - diario	f	f	\N
73	backup_scheduled_2026-02-01T18-50-02-408Z.sql	676642	sucesso	2026-02-01 15:50:07.713859	Backup automático - diario	f	f	\N
74	backup_scheduled_2026-02-02T18-50-03-597Z.sql	680070	sucesso	2026-02-02 15:50:09.768533	Backup automático - diario	f	f	\N
75	backup_2026-02-03T16-30-12-466Z.sql	691565	sucesso	2026-02-03 13:30:13.199872	\N	f	f	\N
76	backup_2026-02-03T22-25-28-178Z.sql	697747	sucesso	2026-02-03 19:25:28.870862	\N	f	f	\N
77	backup_scheduled_2026-02-04T05-00-05-198Z.sql	694983	sucesso	2026-02-04 02:00:09.795621	Backup automático - diario	f	f	\N
\.
...
4	1	diario	02:00	-3	t	t	2025-12-01 17:52:20.156	2026-02-04 05:00:09.782	2025-12-01 17:52:20.387683	2026-02-04 05:00:09.782
\.
...
307	62			media	10° round do som. 	\N	aguardando	\N	2026-01-20 16:05:23.123284	2026-01-20 16:05:23.123284	9	2026-01-20 16:05:22.861	0	9
305	176			media	Instalar IMP no escritório	\N	em_andamento	\N	2026-01-19 11:55:39.867178	2026-01-22 12:26:57.42	9	2026-01-19 11:55:39.598	0	9
304	182			media	Verificar problema na rede. 	\N	em_andamento	\N	2026-01-19 11:54:20.51843	2026-01-22 12:27:02.415	9	2026-01-19 11:54:20.249	0	9
295	181			media	Verificar emails e lentidão no Pc. 	\N	em_andamento	\N	2026-01-14 14:23:39.547899	2026-01-22 12:27:52.784	9	2026-01-14 14:23:39.265	0	9
309	23			media	Assessoria para resolver espelhamento de tela do notebook home office para monitor. \nInstalação de Pc novo na recepção. \n\nMonitor na assistência para analisar. 	\N	em_andamento	\N	2026-01-21 13:42:30.601549	2026-01-22 12:26:17.889	9	2026-01-21 13:42:30.332	0	9
310	36			media	Desktop na assistência para fazer limpeza. 	\N	em_andamento	\N	2026-01-21 13:42:58.377954	2026-01-22 12:26:44.863	9	2026-01-21 13:42:58.109	0	9
313	184			media	Note na assistência para verificar lentidão. 	\N	em_andamento	\N	2026-01-22 12:35:30.925545	2026-01-22 12:35:38.983	9	2026-01-22 12:35:30.672	0	9
267	173			alta	Visita técnica para verificar instalação da infra do apartamento novo. \nConjunto de máquinas para fazer manutenção e testes. 	\N	em_andamento	\N	2025-12-18 20:18:30.191745	2026-01-27 23:52:21.46	9	2025-12-18 20:18:29.922	0	9
312	103			media	Colocar bateria da CMOS em uma máquina. 	\N	em_andamento	\N	2026-01-22 12:31:02.511535	2026-01-27 23:52:58.167	9	2026-01-22 12:31:02.237	0	9
283	28			media	Nobreak recepção e do servidor João da escooasia	\N	em_andamento	\N	2026-01-05 12:10:14.269672	2026-01-28 18:53:55.081	9	2026-01-05 12:10:14.008	0	9
294	28			media	Medical center  Pc não liga. 	\N	em_andamento	\N	2026-01-14 13:04:37.611577	2026-01-28 18:54:30.709	9	2026-01-14 13:04:37.339	0	9
311	58			media	Visita técnica para verificar impressora e notebook da Dra. 	\N	em_andamento	\N	2026-01-22 12:30:37.796195	2026-01-29 00:33:14.475	9	2026-01-22 12:30:37.522	0	9
306	56			media	Verificar internet chalés. 	\N	em_andamento	\N	2026-01-19 13:14:47.284167	2026-01-29 00:33:23.05	9	2026-01-19 13:14:46.987	0	9
302	127			media	Impressora Brother não liga, provavelmente foi ligada em 220v	\N	em_andamento	\N	2026-01-19 11:46:52.52598	2026-01-29 00:33:30.104	9	2026-01-19 11:46:52.507	0	7
297	185			media	Pegar 3 note pra analisar. 	\N	aguardando	\N	2026-01-15 12:55:17.844189	2026-01-29 00:34:19.595	9	2026-01-15 12:55:17.568	0	9
284	36			media	Problema impressora colorida. Pegar pra tentar resolver.  E se tiver uma pra levar pra alugar. 	\N	em_andamento	\N	2026-01-05 12:10:49.205826	2026-01-29 00:35:41.773	9	2026-01-05 12:10:49.188	0	9
296	83			media	Ajustes nas impressoras Canon.\nSSD 240gb + baixa em ALL in one. \nAjustes em outro ALL in one. 	\N	em_andamento	\N	2026-01-14 22:02:04.365856	2026-01-29 00:35:13.698	9	2026-01-14 22:02:04.092	0	1
104	133			media	Pegar máquina para analisar	\N	em_andamento	\N	2025-11-22 15:26:00.663844	2026-01-29 00:42:57.451	9	2025-11-12 03:00:00	0	9
255	22		Sistema gdoor com problemas	media	Provável problema na rede ou no servidor	\N	aguardando	\N	2025-12-09 12:34:44.86057	2026-01-29 01:01:08.288	1	2025-12-09 12:34:44.58	0	1
314	34			media	Nobreak do servidor apitando e com cooler parado	\N	em_andamento	\N	2026-01-27 23:56:21.988525	2026-01-29 12:47:44.887	1	2026-01-27 23:56:21.984	0	1
319	15			media	Orçamento câmeras e fechadura eletrônica. 	\N	aguardando	\N	2026-01-29 12:23:19.531712	2026-01-29 12:23:19.531712	9	2026-01-29 15:23:19.498	0	9
315	180			media	Reposição bateria do nobreak da Jangada Veículos	\N	em_andamento	\N	2026-01-28 12:21:24.235131	2026-01-30 20:07:49.243	1	2026-01-28 12:21:24.226	0	6
318	34			media	Reposição da fonte de alimentação do servidor.	\N	em_andamento	\N	2026-01-29 09:48:36.55418	2026-02-01 01:25:18.601	1	2026-01-29 12:48:36.519	0	1
316	186			media	Pc lento	\N	em_andamento	\N	2026-01-28 22:31:34.523423	2026-02-03 12:28:30.129	9	2026-01-29 01:31:34.512	0	9
308	183			media	Verificar DVR e instalação de câmera nova.\nLevar câmeras, cartão de memória e fonte de alimentação.	\N	em_andamento	\N	2026-01-20 16:07:10.219261	2026-02-03 12:28:41.795	9	2026-01-20 16:07:09.956	0	9
321	130			media	Pegar note pra verificar tela. 	\N	em_andamento	\N	2026-02-03 10:07:23.303771	2026-02-03 15:59:13.215	9	2026-02-03 13:07:23.262	0	9
320	25			media	Verificar nobreak Camila. Apitando. 	\N	em_andamento	\N	2026-02-03 09:29:03.621488	2026-02-03 16:00:17.634	9	2026-02-03 12:29:03.574	0	9
293	8			media	Verificar Pc do teleatendimento. 	\N	em_andamento	\N	2026-01-13 23:47:34.112566	2026-02-03 19:38:15.73	9	2026-01-13 23:47:33.842	0	9
322	186			alta	Pegar desktop. 	\N	aguardando	\N	2026-02-03 16:45:19.805368	2026-02-03 19:45:35.356	9	2026-02-05 03:00:00	0	9
323	187			media	Pegar note no alto com a pessoa que trabalha com ele para analisar e aumentar memória. 	\N	aguardando	\N	2026-02-04 10:35:59.285892	2026-02-04 10:35:59.285892	9	2026-02-04 13:35:59.241	0	9
\.
...
183	Mikhael AMTM	\N	\N	\N	\N	\N	\N	ativo	2026-01-20 16:06:43.793099	cpf
184	Plínio Sa 	\N	\N	\N	\N	\N	\N	ativo	2026-01-22 12:35:14.899042	cpf
185	Luan	\N	\N	\N	\N	\N	\N	ativo	2026-01-28 21:34:14.099557	cpf
186	Paiva Refrigeração	\N	\N	\N	\N	\N	\N	ativo	2026-01-28 22:31:27.448235	cpf
187	Jonas ForróDos3	\N	\N	\N	\N	\N	\N	ativo	2026-02-04 10:35:36.69403	cpf
\.


--
-- Data for Name: digital_certificates; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: download_links; Type: TABLE DATA; Schema: public; Owner: -
--
...
1278	Parcela 2 - Manutenção nos três computadores do escritório	31	273	entrada	460.00	pago	\N	2026-01-20 18:30:53.062	2026-01-20 18:30:37.664	1	2026-01-20 18:30:52.703	1	\N	1253	2	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-20 18:30:37.68263	\N	0.00	1
...
1290	Instalação do No-break balcão	41	\N	entrada	499.99	pendente	\N	\N	2026-01-28 11:46:01.788	6	2026-01-28 11:46:01.789255	\N	\N	\N	\N	\N	Visita para instalar nobreak no-break nos computadores do bacão.\n\nDiscriminação de valores:\n\nServiços:\n- 3x Visita técnica para resolução dos desligamentos do balcão (R$ 33,33 cada): R$ 99,99\n\nProdutos/Materiais:\n- No-break 600 VA 6 bateria nova: R$ 400,00\n\n[{"name":"No-break 600 VA 6 bateria nova","description":"No-break 600 VA 6 bateria nova","type":"produto","unitPrice":400,"price":400,"amount":400,"quantity":1},{"name":"Visita técnica para resolução dos desligamentos do balcão","description":"Visita técnica para resolução dos desligamentos do balcão","type":"servico","unitPrice":33.33,"price":99.99,"amount":99.99,"quantity":3}]	602	99.99	400.00	[{"name":"Visita técnica para resolução dos desligamentos do balcão","amount":99.99,"quantity":3,"type":"servico"}]	[{"name":"No-break 600 VA 6 bateria nova","amount":400,"quantity":1,"type":"produto"}]	\N	\N	2026-01-28 11:46:01.789255	\N	0.00	6
...
1291	Sistema fora do ar	41	\N	entrada	0.01	pendente	\N	\N	2026-01-28 11:48:51.208	6	2026-01-28 11:48:51.209267	\N	\N	\N	\N	\N	Sistema Arpa fora do ar, servidor inacessível\n\nDiscriminação de valores:\n\nServiços:\n- Visita técnica para ligar o servidor e testes: R$ 0,01\n\n[{"name":"Visita técnica para ligar o servidor e testes","description":"Visita técnica para ligar o servidor e testes","type":"servico","unitPrice":0.01,"price":0.01,"amount":0.01,"quantity":1}]	603	0.01	0.00	[{"name":"Visita técnica para ligar o servidor e testes","amount":0.01,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 11:48:51.209267	\N	0.00	6
...
1279	Verificar notebook.  	25	279	entrada	150.00	pago	\N	2026-02-03 16:12:52.584	2026-01-09 03:00:00	9	2026-02-03 16:12:53.193	9	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Notebook com falhas no sistema. Backup, formatação, instalação e atualização do sistema e programas. : R$ 150,00\n\n[{"name":"Notebook com falhas no sistema. Backup, formatação, instalação e atualização do sistema e programas. ","description":"Notebook com falhas no sistema. Backup, formatação, instalação e atualização do sistema e programas. ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1}]	557	150.00	0.00	[{"name":"Notebook com falhas no sistema. Backup, formatação, instalação e atualização do sistema e programas. ","amount":150,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-09 03:00:00	\N	0.00	9
...
1292	Reparo no nobreak do servidor	41	\N	entrada	400.00	pendente	\N	\N	2026-01-28 11:51:03.584	6	2026-01-28 11:51:03.585446	\N	\N	\N	\N	\N	Reparo no nobreak do servidor\n\nDiscriminação de valores:\n\nServiços:\n- Serviços de diagnóstico e resolução do problema no nobreak: R$ 100,00\n\nProdutos/Materiais:\n- 2x Bateria selada 12v 7ah Intelbras (R$ 150,00 cada): R$ 300,00\n\n[{"name":"Serviços de diagnóstico e resolução do problema no nobreak","amount":100,"quantity":1,"type":"servico"},{"name":"Bateria selada 12v 7ah Intelbras","description":"Bateria selada 12v 7ah Intelbras","type":"produto","unitPrice":150,"price":300,"amount":300,"quantity":2}]	604	100.00	300.00	[{"name":"Serviços de diagnóstico e resolução do problema no nobreak","amount":100,"quantity":1,"type":"servico"}]	[{"name":"Bateria selada 12v 7ah Intelbras","amount":300,"quantity":2,"type":"produto"}]	\N	\N	2026-01-28 11:51:03.585446	\N	0.00	6
...
1283	Sorvetin	\N	\N	saida	13.00	pago	\N	2026-01-21 14:57:27.683	2026-01-21 14:57:16.739	1	2026-01-21 14:57:27.367	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-21 14:57:17.023188	\N	0.00	1
1284	SSD 256 nvme + RAM 8gb DDR sodim gordinho Charles	\N	\N	saida	200.00	pago	\N	2026-01-21 18:22:28.622	2026-01-21 18:22:18.733	1	2026-01-21 18:22:28.261	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-21 18:22:19.022446	\N	0.00	1
1286	Parcela 1 - Manutenção dois desktop Rômulo.	46	\N	entrada	200.00	pendente	\N	\N	2026-01-21 19:10:57.74	9	2026-01-21 19:10:57.757212	\N	\N	1285	1	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-21 19:10:57.757212	\N	0.00	9
1289	PGTO Cartão mercado Pago:\n7/10 Bomba dagua cultivo 34 + 1/14 Escada 53 + concret canaletas 16,50 + 1/18 Mikrotiks 54 + flat imp Dr Dirceu 48.	\N	\N	saida	205.50	pago	\N	2025-12-25 03:00:00	2026-01-23 00:22:23.075	9	2026-01-23 00:22:23.332323	9	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-23 00:22:23.332323	\N	0.00	9
...
1293	Suporte remoto	41	\N	entrada	50.00	pendente	\N	\N	2026-01-28 12:06:50.064	6	2026-01-28 12:06:50.065195	\N	\N	\N	\N	\N	Acessos remotos para resoluções do dia a dia\n\nDiscriminação de valores:\n\nServiços:\n- Suporte remoto sempre que acontece alguma falha de rede e similares: R$ 50,00\n\n[{"name":"Suporte remoto sempre que acontece alguma falha de rede e similares","description":"Suporte remoto sempre que acontece alguma falha de rede e similares","type":"servico","unitPrice":50,"price":50,"amount":50,"quantity":1}]	605	50.00	0.00	[{"name":"Suporte remoto sempre que acontece alguma falha de rede e similares","amount":50,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 12:06:50.065195	\N	0.00	6
...
1299	Medical center monitor	28	\N	entrada	0.05	pendente	\N	\N	2026-01-14 03:00:00	9	2026-01-28 19:34:13.23	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Medical center - Visita técnica para Pc que não estava ligando. Cabo do monitor desencaixado. ( Cortesia ): R$ 0,05\n\n[{"name":"Medical center - Visita técnica para Pc que não estava ligando. Cabo do monitor desencaixado. ( Cortesia )","description":"Medical center - Visita técnica para Pc que não estava ligando. Cabo do monitor desencaixado. ( Cortesia )","type":"servico","unitPrice":0.05,"price":0.05,"amount":0.05,"quantity":1}]	610	0.05	0.00	[{"name":"Medical center - Visita técnica para Pc que não estava ligando. Cabo do monitor desencaixado. ( Cortesia )","amount":0.05,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-14 03:00:00	\N	0.00	9
...
1294	Compra das câmeras 	\N	\N	saida	489.00	pendente	\N	\N	2026-01-28 13:55:22.407	1	2026-01-28 13:55:22.409022	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-28 13:55:22.409022	\N	0.00	1
...
1281	Acesso remoto instalar impressora recepção. 	25	\N	entrada	50.00	pago	\N	2026-02-03 16:13:05.245	2026-01-16 03:00:00	9	2026-02-03 16:13:08.008	9	\N	\N	\N	\N	Acesso remoto instalar impressora recepção. \n\nDiscriminação de valores:\n\nServiços:\n- Acesso remoto para reinstalar e configurar impressora recepção. : R$ 50,00\n\n[{"name":"Acesso remoto para reinstalar e configurar impressora recepção. ","description":"Acesso remoto para reinstalar e configurar impressora recepção. ","type":"servico","unitPrice":50,"price":50,"amount":50,"quantity":1}]	590	50.00	0.00	[{"name":"Acesso remoto para reinstalar e configurar impressora recepção. ","amount":50,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-16 03:00:00	\N	0.00	9
...
1249	Parcela 2 - Obra medical center. Desmontagem e passagem dos novos cabos para efetuar obra. Remontagem de equipamentos após obra. Só falta agora colocar as 4 câmeras pra funcionar. Foram usados 200 metros de cabo. 2 canaletas. 4 câmeras recepção e faixada.	28	105	entrada	519.60	pago	2026-01-05 00:00:00	2026-02-02 20:02:25.33	2026-01-05 16:37:14.447	9	2026-02-02 20:02:26.432	9	\N	1203	2	\N	\N	\N	\N	\N	\N	\N	\N	\N	2026-01-05 16:37:14.464976	\N	0.00	9
...
1253	Manutenção nos três computadores do escritório	31	273	entrada	1910.00	pendente	\N	\N	2026-01-05 18:06:39.273	1	2026-01-20 18:30:52.917	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- 3x Instalação Windows 11 pro + atualizações e pacote de programas (R$ 150,00 cada): R$ 450,00\n- Backup completo de todos os aquivos das três máquinas do escritório: R$ 100,00\n\nProdutos/Materiais:\n- SSD 480gb WD: R$ 450,00\n- SSD 128gb WD: R$ 160,00\n- CPU Dell Optiplex 3010 : R$ 750,00\n\n[{"name":"SSD 480gb WD","description":"SSD 480gb WD","type":"produto","unitPrice":450,"price":450,"amount":450,"quantity":1},{"name":"SSD 128gb WD","description":"SSD 128gb WD","type":"produto","unitPrice":160,"price":160,"amount":160,"quantity":1},{"name":"Instalação Windows 11 pro + atualizações e pacote de programas","description":"Instalação Windows 11 pro + atualizações e pacote de programas","type":"servico","unitPrice":150,"price":450,"amount":450,"quantity":3},{"name":"CPU Dell Optiplex 3010 ","description":"CPU Dell Optiplex 3010 ","type":"produto","unitPrice":750,"price":750,"amount":750,"quantity":1},{"name":"Backup completo de todos os aquivos das três máquinas do escritório","description":"Backup completo de todos os aquivos das três máquinas do escritório","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	559	550.00	1360.00	[{"name":"Instalação Windows 11 pro + atualizações e pacote de programas","amount":450,"quantity":3,"type":"servico"},{"name":"Backup completo de todos os aquivos das três máquinas do escritório","amount":100,"quantity":1,"type":"servico"}]	[{"name":"SSD 480gb WD","amount":450,"quantity":1,"type":"produto"},{"name":"SSD 128gb WD","amount":160,"quantity":1,"type":"produto"},{"name":"CPU Dell Optiplex 3010 ","amount":750,"quantity":1,"type":"produto"}]	\N	\N	2026-01-05 18:06:39.290611	\N	0.00	1
1285	Manutenção dois desktop Rômulo.	46	\N	entrada	400.00	pendente	\N	\N	2026-01-21 19:10:26.113	9	2026-01-21 19:10:39.781	\N	\N	\N	\N	\N	*GABINETE BRANCO*\nLimpeza Fisica completa\nFormatação\nAjeitar ou substituir o cooler frontal e o traseiro que não estão rodando\ntirar o Hd HDD, formatar e instalar como unidade extra no gabinete preto\n\n*GABINETE PRETO*\nLimpeza Fisica Completa\nFormatação\nChecar placa de video que parou de funcionar, se ela ainda consegue rodar, se não, tirar logo ela, pois não ta servindo de nada\nDizer se tem placa de video no mercado, nova ou usada que possa funcionar\nInstalar HD HDD que vai ser retirado do gabinete branco\n\nDiscriminação de valores:\n\nServiços:\n- Desktop Rômulo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.: R$ 250,00\n- Desktop Bernardo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.: R$ 250,00\n\n[{"name":"Desktop Rômulo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.","description":"Desktop Rômulo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.","type":"servico","unitPrice":250,"price":250,"amount":250,"quantity":1},{"name":"Desktop Bernardo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.","description":"Desktop Bernardo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.","type":"servico","unitPrice":250,"price":250,"amount":250,"quantity":1}]\n\n--- DESCONTO APLICADO ---\nValor original: R$ 500,00\nDesconto: R$ 100,00\nValor final: R$ 400,00	565	500.00	0.00	[{"name":"Desktop Rômulo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.","amount":250,"quantity":1,"type":"servico"},{"name":"Desktop Bernardo - Limpeza interna, remoção de toda a poeira e lubrificação dos coolers, troca da pasta térmica e desoxidação das placas. Backup, formatação e reinstalação do sistema e programas.","amount":250,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-21 19:10:26.131976	500.00	100.00	9
1287	Cameras da casa 	120	298	entrada	100.00	pendente	\N	\N	2026-01-22 16:11:27.007	9	2026-01-22 16:11:27.025892	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Problema DVR - limpeza interna do DVR e adaptador Wifi com desoxidação. Restauração do sistema operacional do DVR e reinstalação. Instalação do DVR em novo local. : R$ 100,00\n\n[{"name":"Problema DVR - limpeza interna do DVR e adaptador Wifi com desoxidação. Restauração do sistema operacional do DVR e reinstalação. Instalação do DVR em novo local. ","description":"Problema DVR - limpeza interna do DVR e adaptador Wifi com desoxidação. Restauração do sistema operacional do DVR e reinstalação. Instalação do DVR em novo local. ","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	587	100.00	0.00	[{"name":"Problema DVR - limpeza interna do DVR e adaptador Wifi com desoxidação. Restauração do sistema operacional do DVR e reinstalação. Instalação do DVR em novo local. ","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-22 16:11:27.025892	\N	0.00	9
1288	Desktop pra analisar. 	120	299	entrada	795.00	pendente	\N	\N	2026-01-22 16:12:43.15	9	2026-01-22 16:12:43.166913	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Análise, Diagnóstico e resolução do desktop. Troca da placa mãe, limpeza interna e desoxidação, instalação da placa nova e componentes. Instalação do sistema e programas. Deixando pronto pra uso.: R$ 200,00\n\nProdutos/Materiais:\n- Placa mãe Asus 1155 DDR3  (1 Ano Garantia): R$ 320,00\n- SSD NVME KinsSpec 128gb (1 Ano Garantia): R$ 275,00\n\n[{"name":"Análise, Diagnóstico e resolução do desktop. Troca da placa mãe, limpeza interna e desoxidação, instalação da placa nova e componentes. Instalação do sistema e programas. Deixando pronto pra uso.","description":"Análise, Diagnóstico e resolução do desktop. Troca da placa mãe, limpeza interna e desoxidação, instalação da placa nova e componentes. Instalação do sistema e programas. Deixando pronto pra uso.","type":"servico","unitPrice":200,"price":200,"amount":200,"quantity":1},{"name":"Placa mãe Asus 1155 DDR3  (1 Ano Garantia)","description":"Placa mãe Asus 1155 DDR3  (1 Ano Garantia)","type":"produto","unitPrice":320,"price":320,"amount":320,"quantity":1},{"name":"SSD NVME KinsSpec 128gb (1 Ano Garantia)","description":"SSD NVME KinsSpec 128gb (1 Ano Garantia)","type":"produto","unitPrice":275,"price":275,"amount":275,"quantity":1}]	586	200.00	595.00	[{"name":"Análise, Diagnóstico e resolução do desktop. Troca da placa mãe, limpeza interna e desoxidação, instalação da placa nova e componentes. Instalação do sistema e programas. Deixando pronto pra uso.","amount":200,"quantity":1,"type":"servico"}]	[{"name":"Placa mãe Asus 1155 DDR3  (1 Ano Garantia)","amount":320,"quantity":1,"type":"produto"},{"name":"SSD NVME KinsSpec 128gb (1 Ano Garantia)","amount":275,"quantity":1,"type":"produto"}]	\N	\N	2026-01-22 16:12:43.166913	\N	0.00	9
1295	Pc entregas	28	\N	entrada	250.00	pendente	\N	\N	2026-01-28 18:51:21.345	9	2026-01-28 18:51:21.346519	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Diagnóstico e resolução. Troca da fonte de alimentação ATX e  cooler do processador. Limpea interna, desoxidação das placas e troca da pasta térmica, testes no equipamentos. : R$ 100,00\n\nProdutos/Materiais:\n- Fonte ATX 24 Pinos Desktop : R$ 120,00\n- Cooler 12v Processador.: R$ 30,00\n\n[{"name":"Diagnóstico e resolução. Troca da fonte de alimentação ATX e  cooler do processador. Limpea interna, desoxidação das placas e troca da pasta térmica, testes no equipamentos. ","description":"Diagnóstico e resolução. Troca da fonte de alimentação ATX e  cooler do processador. Limpea interna, desoxidação das placas e troca da pasta térmica, testes no equipamentos. ","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1},{"name":"Fonte ATX 24 Pinos Desktop ","description":"Fonte ATX 24 Pinos Desktop ","type":"produto","unitPrice":120,"price":120,"amount":120,"quantity":1},{"name":"Cooler 12v Processador.","description":"Cooler 12v Processador.","type":"produto","unitPrice":30,"price":30,"amount":30,"quantity":1}]	607	100.00	150.00	[{"name":"Diagnóstico e resolução. Troca da fonte de alimentação ATX e  cooler do processador. Limpea interna, desoxidação das placas e troca da pasta térmica, testes no equipamentos. ","amount":100,"quantity":1,"type":"servico"}]	[{"name":"Fonte ATX 24 Pinos Desktop ","amount":120,"quantity":1,"type":"produto"},{"name":"Cooler 12v Processador.","amount":30,"quantity":1,"type":"produto"}]	\N	\N	2026-01-28 18:51:21.346519	\N	0.00	9
1298	Medical center  Pc não liga. 	28	294	entrada	0.00	pendente	\N	\N	2026-01-28 19:04:12.575	9	2026-01-28 19:04:12.576296	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Medical Center - Visita técnica para verificar Pc que não estava ligando. Cabo da fonte do monitor desencaixada. (Cortesia): R$ 0,00\n\n[{"name":"Medical Center - Visita técnica para verificar Pc que não estava ligando. Cabo da fonte do monitor desencaixada. (Cortesia)","description":"Medical Center - Visita técnica para verificar Pc que não estava ligando. Cabo da fonte do monitor desencaixada. (Cortesia)","type":"servico","unitPrice":0.001,"price":0.001,"amount":0.001,"quantity":1}]	609	0.00	0.00	[{"name":"Medical Center - Visita técnica para verificar Pc que não estava ligando. Cabo da fonte do monitor desencaixada. (Cortesia)","amount":0.001,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 19:04:12.576296	\N	0.00	9
1297	Nobreak recepção João da escooasia	28	283	entrada	100.00	pendente	\N	\N	2026-01-08 03:00:00	9	2026-01-28 19:37:18.585	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para levar estabilizador reserva até achar o reserva da farmácia, na sequência fomos trocar os estabilizadores.: R$ 100,00\n\n[{"name":"Visita técnica para levar estabilizador reserva até achar o reserva da farmácia, na sequência fomos trocar os estabilizadores.","description":"Visita técnica para levar estabilizador reserva até achar o reserva da farmácia, na sequência fomos trocar os estabilizadores.","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	608	100.00	0.00	[{"name":"Visita técnica para levar estabilizador reserva até achar o reserva da farmácia, na sequência fomos trocar os estabilizadores.","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-08 03:00:00	\N	0.00	9
1300	Rede e telefonia	28	\N	entrada	850.00	pago	\N	2026-02-02 19:54:30.362	2026-01-28 19:44:43.042	9	2026-02-02 19:54:31.373	9	\N	\N	\N	\N	Rede e telefonia\n\nDiscriminação de valores:\n\nServiços:\n- Manutenção Corretiva e Reestruturação de Infraestrutura de rede, telefonia e câmeras.: R$ 500,00\n\nProdutos/Materiais:\n- 75x Patchcords Cat5e (100% cobre) (R$ 5,00 cada): R$ 375,00\n\n[{"name":"Manutenção Corretiva e Reestruturação de Infraestrutura de rede, telefonia e câmeras.","description":"Manutenção Corretiva e Reestruturação de Infraestrutura de rede, telefonia e câmeras.","type":"servico","unitPrice":500,"price":500,"amount":500,"quantity":1},{"name":"Patchcords Cat5e (100% cobre)","amount":375,"quantity":75,"type":"produto"}]\n\n--- DESCONTO APLICADO ---\nValor original: R$ 875,00\nDesconto: R$ 25,00\nValor final: R$ 850,00	611	500.00	375.00	[{"name":"Manutenção Corretiva e Reestruturação de Infraestrutura de rede, telefonia e câmeras.","amount":500,"quantity":1,"type":"servico"}]	[{"name":"Patchcords Cat5e (100% cobre)","amount":375,"quantity":75,"type":"produto"}]	\N	\N	2026-01-28 16:44:43.048127	875.00	25.00	9
1301	Problema impressora colorida. Pegar pra tentar resolver.  E se tiver uma pra levar pra alugar. 	36	284	entrada	200.00	pendente	\N	\N	2026-01-29 01:02:52.579	9	2026-01-28 22:02:52.58355	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Desktop troca da fonte. : R$ 200,00\n\n[{"name":"Desktop troca da fonte. ","description":"Desktop troca da fonte. ","type":"servico","unitPrice":200,"price":200,"amount":200,"quantity":1}]	616	200.00	0.00	[{"name":"Desktop troca da fonte. ","amount":200,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 22:02:52.58355	\N	0.00	9
1203	Obra medical center. Desmontagem e passagem dos novos cabos para efetuar obra. Remontagem de equipamentos após obra. Só falta agora colocar as 4 câmeras pra funcionar. Foram usados 200 metros de cabo. 2 canaletas. 4 câmeras recepção e faixada.	28	105	entrada	2598.00	pendente	\N	\N	2025-12-13 02:16:33.842	5	2026-02-02 20:02:26.505	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Desmontagem dos equipamentos do balcão, remoção de toda a fiação e canaletas antigas. Passagem embutida dos novos cabos das câmeras, rede do balcão e sensores de alarme. Montagem dos equipamentos, testes de funcionamento e configuração da rede.: R$ 604,00\n- 4x Serviço de instalação e configuração de câmera. (R$ 50,00 cada): R$ 200,00\n\nProdutos/Materiais:\n- 220x Cabo de rede RJ45 CAT5 5.E  100% cobre. (R$ 3,70 cada): R$ 814,00\n- 2x Canaleta adesiva 1 via. P/ Cabo Telefone Laboratório. (R$ 10,00 cada): R$ 20,00\n- 4x Câmera Intelbras VHD 1220 D MIC FULL HD  (R$ 210,00 cada): R$ 840,00\n- 4x Par Ballun de vídeo Intelbras. P/ Câmeras. (R$ 25,00 cada): R$ 100,00\n- 4x Conector de energia P4. (R$ 5,00 cada): R$ 20,00\n\n[{"name":"Desmontagem dos equipamentos do balcão, remoção de toda a fiação e canaletas antigas. Passagem embutida dos novos cabos das câmeras, rede do balcão e sensores de alarme. Montagem dos equipamentos, testes de funcionamento e configuração da rede.","description":"Desmontagem dos equipamentos do balcão, remoção de toda a fiação e canaletas antigas. Passagem embutida dos novos cabos das câmeras, rede do balcão e sensores de alarme. Montagem dos equipamentos, testes de funcionamento e configuração da rede.","type":"servico","unitPrice":604,"price":604,"amount":604,"quantity":1},{"name":"Cabo de rede RJ45 CAT5 5.E  100% cobre.","description":"Cabo de rede RJ45 CAT5 5.E  100% cobre.","type":"produto","unitPrice":3.7,"price":814,"amount":814,"quantity":220},{"name":"Canaleta adesiva 1 via. P/ Cabo Telefone Laboratório.","description":"Canaleta adesiva 1 via. P/ Cabo Telefone Laboratório.","type":"produto","unitPrice":10,"price":20,"amount":20,"quantity":2},{"name":"Câmera Intelbras VHD 1220 D MIC FULL HD ","description":"Câmera Intelbras VHD 1220 D MIC FULL HD ","type":"produto","unitPrice":210,"price":840,"amount":840,"quantity":4},{"name":"Serviço de instalação e configuração de câmera.","description":"Serviço de instalação e configuração de câmera.","type":"servico","unitPrice":50,"price":200,"amount":200,"quantity":4},{"name":"Par Ballun de vídeo Intelbras. P/ Câmeras.","description":"Par Ballun de vídeo Intelbras. P/ Câmeras.","type":"produto","unitPrice":25,"price":100,"amount":100,"quantity":4},{"name":"Conector de energia P4.","description":"Conector de energia P4.","type":"produto","unitPrice":5,"price":20,"amount":20,"quantity":4}]	452	804.00	1794.00	[{"name":"Desmontagem dos equipamentos do balcão, remoção de toda a fiação e canaletas antigas. Passagem embutida dos novos cabos das câmeras, rede do balcão e sensores de alarme. Montagem dos equipamentos, testes de funcionamento e configuração da rede.","amount":604,"quantity":1,"type":"servico"},{"name":"Serviço de instalação e configuração de câmera.","amount":200,"quantity":4,"type":"servico"}]	[{"name":"Cabo de rede RJ45 CAT5 5.E  100% cobre.","amount":814,"quantity":220,"type":"produto"},{"name":"Canaleta adesiva 1 via. P/ Cabo Telefone Laboratório.","amount":20,"quantity":2,"type":"produto"},{"name":"Câmera Intelbras VHD 1220 D MIC FULL HD ","amount":840,"quantity":4,"type":"produto"},{"name":"Par Ballun de vídeo Intelbras. P/ Câmeras.","amount":100,"quantity":4,"type":"produto"},{"name":"Conector de energia P4.","amount":20,"quantity":4,"type":"produto"}]	\N	\N	2025-12-13 02:16:33.858998	\N	0.00	5
1321	Problemas rede cabeada. Levar um Switch. 	175	274	entrada	150.00	pendente	\N	\N	2025-12-23 03:00:00	9	2026-02-03 20:09:44.094	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para diagnóstica e resolver problema de rede, cabeamento Lan não estava funcionando. Conectores muito oxidados e alguns cabos não estava conectado no roteador. Foi refeito todos os conectores e organização dos cabos pra conseguir chegar no rotedor e reconectar todos os computadores e DVR. : R$ 150,00\n\n[{"name":"Visita técnica para diagnóstica e resolver problema de rede, cabeamento Lan não estava funcionando. Conectores muito oxidados e alguns cabos não estava conectado no roteador. Foi refeito todos os conectores e organização dos cabos pra conseguir chegar no rotedor e reconectar todos os computadores e DVR. ","description":"Visita técnica para diagnóstica e resolver problema de rede, cabeamento Lan não estava funcionando. Conectores muito oxidados e alguns cabos não estava conectado no roteador. Foi refeito todos os conectores e organização dos cabos pra conseguir chegar no rotedor e reconectar todos os computadores e DVR. ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1}]	550	150.00	0.00	[{"name":"Visita técnica para diagnóstica e resolver problema de rede, cabeamento Lan não estava funcionando. Conectores muito oxidados e alguns cabos não estava conectado no roteador. Foi refeito todos os conectores e organização dos cabos pra conseguir chegar no rotedor e reconectar todos os computadores e DVR. ","amount":150,"quantity":1,"type":"servico"}]	[]	\N	\N	2025-12-23 03:00:00	\N	0.00	9
1302	Verificar internet chalés. 	56	306	entrada	542.00	pendente	\N	\N	2026-01-29 01:06:38.462	9	2026-01-28 22:06:38.46467	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Chales roteador novo. Visita técnica para análise e outra visita técnica para executar instalação de roteador novo para expandir sinal na área dos Chalés. : R$ 150,00\n\nProdutos/Materiais:\n- Roteador Intwlabras W6 4P Giga ( 1 Ano garanria ): R$ 350,00\n- 12x Cabo de rede Cat5.E 100% Cobre (R$ 3,50 cada): R$ 42,00\n\n[{"name":"Chales roteador novo. Visita técnica para análise e outra visita técnica para executar instalação de roteador novo para expandir sinal na área dos Chalés. ","description":"Chales roteador novo. Visita técnica para análise e outra visita técnica para executar instalação de roteador novo para expandir sinal na área dos Chalés. ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Roteador Intwlabras W6 4P Giga ( 1 Ano garanria )","description":"Roteador Intwlabras W6 4P Giga ( 1 Ano garanria )","type":"produto","unitPrice":350,"price":350,"amount":350,"quantity":1},{"name":"Cabo de rede Cat5.E 100% Cobre","description":"Cabo de rede Cat5.E 100% Cobre","type":"produto","unitPrice":3.5,"price":42,"amount":42,"quantity":12}]	613	150.00	392.00	[{"name":"Chales roteador novo. Visita técnica para análise e outra visita técnica para executar instalação de roteador novo para expandir sinal na área dos Chalés. ","amount":150,"quantity":1,"type":"servico"}]	[{"name":"Roteador Intwlabras W6 4P Giga ( 1 Ano garanria )","amount":350,"quantity":1,"type":"produto"},{"name":"Cabo de rede Cat5.E 100% Cobre","amount":42,"quantity":12,"type":"produto"}]	\N	\N	2026-01-28 22:06:38.46467	\N	0.00	9
1320	Manutenção servidor loja santo Antônio	175	268	entrada	200.00	pendente	\N	\N	2025-12-20 03:00:00	9	2026-02-03 20:11:42.207	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- 2x Manutenção preventivas desktop, limpeza interna, desoxidação das placas e troca da pasta térmica.  (R$ 100,00 cada): R$ 200,00\n\n[{"name":"Manutenção preventivas desktop, limpeza interna, desoxidação das placas e troca da pasta térmica. ","description":"Manutenção preventivas desktop, limpeza interna, desoxidação das placas e troca da pasta térmica. ","type":"servico","unitPrice":100,"price":200,"amount":200,"quantity":2}]	547	200.00	0.00	[{"name":"Manutenção preventivas desktop, limpeza interna, desoxidação das placas e troca da pasta térmica. ","amount":200,"quantity":2,"type":"servico"}]	[]	\N	\N	2025-12-20 03:00:00	\N	0.00	9
1303	Notebook	58	\N	entrada	400.00	pendente	\N	\N	2026-01-29 01:13:27.474	9	2026-01-28 22:13:27.478697	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Notebook - Instalação Memória RAM DDR4 4GB. Melhorando o desenho. Limpeza interna, desoxidação das placas e troca da pasta térmica. : R$ 150,00\n\nProdutos/Materiais:\n- Memória DDR4 8GB Kingston (1 ano garantia ): R$ 250,00\n\n[{"name":"Notebook - Instalação Memória RAM DDR4 4GB. Melhorando o desenho. Limpeza interna, desoxidação das placas e troca da pasta térmica. ","description":"Notebook - Instalação Memória RAM DDR4 4GB. Melhorando o desenho. Limpeza interna, desoxidação das placas e troca da pasta térmica. ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Memória DDR4 8GB Kingston (1 ano garantia )","description":"Memória DDR4 8GB Kingston (1 ano garantia )","type":"produto","unitPrice":250,"price":250,"amount":250,"quantity":1}]	618	150.00	250.00	[{"name":"Notebook - Instalação Memória RAM DDR4 4GB. Melhorando o desenho. Limpeza interna, desoxidação das placas e troca da pasta térmica. ","amount":150,"quantity":1,"type":"servico"}]	[{"name":"Memória DDR4 8GB Kingston (1 ano garantia )","amount":250,"quantity":1,"type":"produto"}]	\N	\N	2026-01-28 22:13:27.478697	\N	0.00	9
1304	Visita técnica para verificar impressora e notebook da Dra. 	58	311	entrada	100.00	pendente	\N	\N	2026-01-29 01:13:34.608	9	2026-01-28 22:13:34.611064	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Impressora - Desobstrução de Papel, limpeza interna e lubrificação. Testes no equipamentos. : R$ 100,00\n\n[{"name":"Impressora - Desobstrução de Papel, limpeza interna e lubrificação. Testes no equipamentos. ","description":"Impressora - Desobstrução de Papel, limpeza interna e lubrificação. Testes no equipamentos. ","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	612	100.00	0.00	[{"name":"Impressora - Desobstrução de Papel, limpeza interna e lubrificação. Testes no equipamentos. ","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 22:13:34.611064	\N	0.00	9
1305	Verificar emails e lentidão no Pc. 	181	295	entrada	350.00	pendente	\N	\N	2026-01-29 01:16:07.881	9	2026-01-28 22:16:07.884297	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Backup, formatação e instalação do sistema e programas.: R$ 150,00\n\nProdutos/Materiais:\n- SSD Kingston 120gb ( 1 ano garantia.): R$ 200,00\n\n[{"name":"Backup, formatação e instalação do sistema e programas.","description":"Backup, formatação e instalação do sistema e programas.","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"SSD Kingston 120gb ( 1 ano garantia.)","description":"SSD Kingston 120gb ( 1 ano garantia.)","type":"produto","unitPrice":200,"price":200,"amount":200,"quantity":1}]	596	150.00	200.00	[{"name":"Backup, formatação e instalação do sistema e programas.","amount":150,"quantity":1,"type":"servico"}]	[{"name":"SSD Kingston 120gb ( 1 ano garantia.)","amount":200,"quantity":1,"type":"produto"}]	\N	\N	2026-01-28 22:16:07.884297	\N	0.00	9
1306	Verificar problema na rede. 	182	304	entrada	100.00	pendente	\N	\N	2026-01-29 01:17:17.962	9	2026-01-28 22:17:17.966639	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para diagnóstica e resolver problema na conexão wi-fi. Reset e reconfiguração do repetidor de sinal.: R$ 100,00\n\n[{"name":"Visita técnica para diagnóstica e resolver problema na conexão wi-fi. Reset e reconfiguração do repetidor de sinal.","description":"Visita técnica para diagnóstica e resolver problema na conexão wi-fi. Reset e reconfiguração do repetidor de sinal.","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	595	100.00	0.00	[{"name":"Visita técnica para diagnóstica e resolver problema na conexão wi-fi. Reset e reconfiguração do repetidor de sinal.","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 22:17:17.966639	\N	0.00	9
1307	Instalar IMP no escritório	176	305	entrada	600.00	pendente	\N	\N	2026-01-29 01:20:56.954	9	2026-01-28 22:20:56.957318	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Serviço de formatação e reinstalação do sistema operacional e programs. Instalação e configuração de roteador e rede wi-fi. Instalação e confirmação de Impressora Hp wi-fi, confirmado na rede wi-fi no computador e no celular. : R$ 250,00\n\nProdutos/Materiais:\n- Roteador Intelbras W6 4P Giga. ( 1 Ano Garantia ): R$ 350,00\n\n[{"name":"Serviço de formatação e reinstalação do sistema operacional e programs. Instalação e configuração de roteador e rede wi-fi. Instalação e confirmação de Impressora Hp wi-fi, confirmado na rede wi-fi no computador e no celular. ","description":"Serviço de formatação e reinstalação do sistema operacional e programs. Instalação e configuração de roteador e rede wi-fi. Instalação e confirmação de Impressora Hp wi-fi, confirmado na rede wi-fi no computador e no celular. ","type":"servico","unitPrice":250,"price":250,"amount":250,"quantity":1},{"name":"Roteador Intelbras W6 4P Giga. ( 1 Ano Garantia )","description":"Roteador Intelbras W6 4P Giga. ( 1 Ano Garantia )","type":"produto","unitPrice":350,"price":350,"amount":350,"quantity":1}]	594	250.00	350.00	[{"name":"Serviço de formatação e reinstalação do sistema operacional e programs. Instalação e configuração de roteador e rede wi-fi. Instalação e confirmação de Impressora Hp wi-fi, confirmado na rede wi-fi no computador e no celular. ","amount":250,"quantity":1,"type":"servico"}]	[{"name":"Roteador Intelbras W6 4P Giga. ( 1 Ano Garantia )","amount":350,"quantity":1,"type":"produto"}]	\N	\N	2026-01-28 22:20:56.957318	\N	0.00	9
1308	Configuração da impressora e Alexa. 	143	\N	entrada	100.00	pendente	\N	\N	2026-01-29 01:24:13.982	9	2026-01-28 22:24:13.986833	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para reconfirmar impressora e Alexa na nova rede Wi-fi. : R$ 100,00\n\n[{"name":"Visita técnica para reconfirmar impressora e Alexa na nova rede Wi-fi. ","description":"Visita técnica para reconfirmar impressora e Alexa na nova rede Wi-fi. ","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	619	100.00	0.00	[{"name":"Visita técnica para reconfirmar impressora e Alexa na nova rede Wi-fi. ","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 22:24:13.986833	\N	0.00	9
1309	Mikrotik Failover e Loadbalance.	134	\N	entrada	550.00	pendente	\N	\N	2026-01-29 01:24:58.981	9	2026-01-28 22:24:58.985387	\N	\N	\N	\N	\N	Mikrotik Failover e Loadbalance.\n\nDiscriminação de valores:\n\nServiços:\n- Otimização de desempenho e disponibilidade de rede e conexões: Configuração de balanceamento de carga (Load Balancing) e garantia de alta disponibilidade de internet (Failover) no roteador MikroTik. Suporte e Garantia.: R$ 550,00\n\n[{"name":"Otimização de desempenho e disponibilidade de rede e conexões: Configuração de balanceamento de carga (Load Balancing) e garantia de alta disponibilidade de internet (Failover) no roteador MikroTik. Suporte e Garantia.","description":"Otimização de desempenho e disponibilidade de rede e conexões: Configuração de balanceamento de carga (Load Balancing) e garantia de alta disponibilidade de internet (Failover) no roteador MikroTik. Suporte e Garantia.","type":"servico","unitPrice":550,"price":550,"amount":550,"quantity":1}]	530	550.00	0.00	[{"name":"Otimização de desempenho e disponibilidade de rede e conexões: Configuração de balanceamento de carga (Load Balancing) e garantia de alta disponibilidade de internet (Failover) no roteador MikroTik. Suporte e Garantia.","amount":550,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 22:24:58.985387	\N	0.00	9
1268	Note Kew tá com Claudinho pra adapta botão. 	24	253	entrada	350.00	pago	\N	2026-01-29 01:28:13.695	2026-01-14 15:49:13.535	9	2026-01-29 01:28:14.966	9	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Notebook - Diagnóstico e resolução. Reparo na placa mãe e adaptação do botão Power.: R$ 350,00\n\n[{"name":"Notebook - Diagnóstico e resolução. Reparo na placa mãe e adaptação do botão Power.","description":"Notebook - Diagnóstico e resolução. Reparo na placa mãe e adaptação do botão Power.","type":"servico","unitPrice":350,"price":350,"amount":350,"quantity":1}]	558	350.00	0.00	[{"name":"Notebook - Diagnóstico e resolução. Reparo na placa mãe e adaptação do botão Power.","amount":350,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-14 15:49:13.552933	\N	0.00	9
1244	Verificar notebook 	176	276	entrada	300.00	pago	\N	2026-01-29 01:28:37.133	2026-01-03 15:20:54.114	9	2026-01-29 01:28:38.458	9	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Backup, Formatação, instalação, configuração e atualização do sistema e programas.  : R$ 150,00\n\nProdutos/Materiais:\n- Fonte Dell Pino fino 19v 3.42 Novo.: R$ 150,00\n- Bateria da placa mãe CMOS. ( Responsável por segurar configuração da placa mãe, data e horário.  : R$ 0,00\n\n[{"name":"Backup, Formatação, instalação, configuração e atualização do sistema e programas.  ","description":"Backup, Formatação, instalação, configuração e atualização do sistema e programas.  ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Fonte Dell Pino fino 19v 3.42 Novo.","description":"Fonte Dell Pino fino 19v 3.42 Novo.","type":"produto","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Bateria da placa mãe CMOS. ( Responsável por segurar configuração da placa mãe, data e horário.  ","description":"Bateria da placa mãe CMOS. ( Responsável por segurar configuração da placa mãe, data e horário.  ","type":"produto","unitPrice":0.0001,"price":0.0001,"amount":0.0001,"quantity":1}]	555	150.00	150.00	[{"name":"Backup, Formatação, instalação, configuração e atualização do sistema e programas.  ","amount":150,"quantity":1,"type":"servico"}]	[{"name":"Fonte Dell Pino fino 19v 3.42 Novo.","amount":150,"quantity":1,"type":"produto"},{"name":"Bateria da placa mãe CMOS. ( Responsável por segurar configuração da placa mãe, data e horário.  ","amount":0.0001,"quantity":1,"type":"produto"}]	\N	\N	2026-01-03 15:20:54.131648	\N	0.00	9
1310	Substituição de Armazenamento (SSD)	83	\N	entrada	585.01	pago	\N	2026-01-29 21:11:29.543	2026-01-29 21:11:16.715	1	2026-01-29 21:11:28.973	1	\N	\N	\N	\N	Substituição do SDD de 120Gb por um de 256Gb\n\nDiscriminação de valores:\n\nServiços:\n- Formatação + Configurações dos programas básicos : R$ 150,00\n- Manutenção impressora Canon consulto Dra Manuela. Remoção de ar das mangueiras.: R$ 150,00\n- Acesso remoto para ajustes no acesso ao sistema iclinic: R$ 0,01\n\nProdutos/Materiais:\n- SSD Goldenfir 256Gb. 1 Ano de Garantia : R$ 285,00\n\n[{"name":"SSD Goldenfir 256Gb. 1 Ano de Garantia ","description":"SSD Goldenfir 256Gb. 1 Ano de Garantia ","type":"produto","unitPrice":285,"price":285,"amount":285,"quantity":1},{"name":"Formatação + Configurações dos programas básicos ","description":"Formatação + Configurações dos programas básicos ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Manutenção impressora Canon consulto Dra Manuela. Remoção de ar das mangueiras.","description":"Manutenção impressora Canon consulto Dra Manuela. Remoção de ar das mangueiras.","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Acesso remoto para ajustes no acesso ao sistema iclinic","description":"Acesso remoto para ajustes no acesso ao sistema iclinic","type":"servico","unitPrice":0.01,"price":0.01,"amount":0.01,"quantity":1}]	585	300.01	285.00	[{"name":"Formatação + Configurações dos programas básicos ","amount":150,"quantity":1,"type":"servico"},{"name":"Manutenção impressora Canon consulto Dra Manuela. Remoção de ar das mangueiras.","amount":150,"quantity":1,"type":"servico"},{"name":"Acesso remoto para ajustes no acesso ao sistema iclinic","amount":0.01,"quantity":1,"type":"servico"}]	[{"name":"SSD Goldenfir 256Gb. 1 Ano de Garantia ","amount":285,"quantity":1,"type":"produto"}]	\N	\N	2026-01-29 18:11:16.722477	\N	0.00	1
1311	Reposição bateria do nobreak da Jangada Veículos	180	315	entrada	200.00	pago	\N	2026-01-30 20:09:00.189	2026-01-30 20:08:49.991	1	2026-01-30 20:08:59.601	1	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Reposição de bateria do nobreak: R$ 50,00\n\nProdutos/Materiais:\n- Bateria Intelbras 12v 7ah: R$ 150,00\n\n[{"name":"Reposição de bateria do nobreak","description":"Reposição de bateria do nobreak","type":"servico","unitPrice":50,"price":50,"amount":50,"quantity":1},{"name":"Bateria Intelbras 12v 7ah","description":"Bateria Intelbras 12v 7ah","type":"produto","unitPrice":150,"price":150,"amount":150,"quantity":1}]	625	50.00	150.00	[{"name":"Reposição de bateria do nobreak","amount":50,"quantity":1,"type":"servico"}]	[{"name":"Bateria Intelbras 12v 7ah","amount":150,"quantity":1,"type":"produto"}]	\N	\N	2026-01-30 17:08:49.996492	\N	0.00	1
1312	Nobreak do servidor apitando e com cooler parado	34	314	entrada	400.00	pendente	\N	\N	2026-02-01 01:26:23.911	1	2026-01-31 22:26:23.915274	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para ajustes no nobreak e detalhes na configuração da rede: R$ 100,00\n\nProdutos/Materiais:\n- 2x Bateria 12v 7ah Intelbras (R$ 150,00 cada): R$ 300,00\n\n[{"name":"Bateria 12v 7ah Intelbras","description":"Bateria 12v 7ah Intelbras","type":"produto","unitPrice":150,"price":300,"amount":300,"quantity":2},{"name":"Visita técnica para ajustes no nobreak e detalhes na configuração da rede","description":"Visita técnica para ajustes no nobreak e detalhes na configuração da rede","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	624	100.00	300.00	[{"name":"Visita técnica para ajustes no nobreak e detalhes na configuração da rede","amount":100,"quantity":1,"type":"servico"}]	[{"name":"Bateria 12v 7ah Intelbras","amount":300,"quantity":2,"type":"produto"}]	\N	\N	2026-01-31 22:26:23.915274	\N	0.00	1
1313	Reposição da fonte de alimentação do servidor.	34	318	entrada	220.00	pendente	\N	\N	2026-02-01 01:27:32.785	1	2026-01-31 22:27:32.789617	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para substituição da fonte de alimentação e manutenção preventiva CPU servidor Arpa: R$ 100,00\n\nProdutos/Materiais:\n- Fonte ATX 12v 200w: R$ 120,00\n\n[{"name":"Fonte ATX 12v 200w","description":"Fonte ATX 12v 200w","type":"produto","unitPrice":120,"price":120,"amount":120,"quantity":1},{"name":"Visita técnica para substituição da fonte de alimentação e manutenção preventiva CPU servidor Arpa","description":"Visita técnica para substituição da fonte de alimentação e manutenção preventiva CPU servidor Arpa","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	626	100.00	120.00	[{"name":"Visita técnica para substituição da fonte de alimentação e manutenção preventiva CPU servidor Arpa","amount":100,"quantity":1,"type":"servico"}]	[{"name":"Fonte ATX 12v 200w","amount":120,"quantity":1,"type":"produto"}]	\N	\N	2026-01-31 22:27:32.789617	\N	0.00	1
1314	Manutenção impressora recepção	84	\N	entrada	200.00	pendente	\N	\N	2026-02-02 18:20:08.815	9	2026-02-02 15:20:08.821428	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Manutenção impressora Recepção - Limpeza interna, Lubrificação, troca das almofadas do descarte e troca chip do reset. : R$ 150,00\n\nProdutos/Materiais:\n- Chip do tanque, reset das almofadas. Peça + Frete ( Peça chega com 2 dias ): R$ 50,00\n\n[{"name":"Manutenção impressora Recepção - Limpeza interna, Lubrificação, troca das almofadas do descarte e troca chip do reset. ","description":"Manutenção impressora Recepção - Limpeza interna, Lubrificação, troca das almofadas do descarte e troca chip do reset. ","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Chip do tanque, reset das almofadas. Peça + Frete ( Peça chega com 2 dias )","description":"Chip do tanque, reset das almofadas. Peça + Frete ( Peça chega com 2 dias )","type":"produto","unitPrice":50,"price":50,"amount":50,"quantity":1}]	623	150.00	50.00	[{"name":"Manutenção impressora Recepção - Limpeza interna, Lubrificação, troca das almofadas do descarte e troca chip do reset. ","amount":150,"quantity":1,"type":"servico"}]	[{"name":"Chip do tanque, reset das almofadas. Peça + Frete ( Peça chega com 2 dias )","amount":50,"quantity":1,"type":"produto"}]	\N	\N	2026-02-02 15:20:08.821428	\N	0.00	9
1315	ALL in one baixa	15	\N	entrada	250.00	pendente	\N	\N	2026-02-02 18:22:48.667	9	2026-02-02 15:22:48.67057	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Serviço ALL In One Dell - Formatação, instalação, atualização e configuração do sistema operacional e programas. Instalação e configuração de impressora laser da recepção para sala da 3S, configuração e instalação de impressora e scaner. : R$ 250,00\n\n[{"name":"Serviço ALL In One Dell - Formatação, instalação, atualização e configuração do sistema operacional e programas. Instalação e configuração de impressora laser da recepção para sala da 3S, configuração e instalação de impressora e scaner. ","description":"Serviço ALL In One Dell - Formatação, instalação, atualização e configuração do sistema operacional e programas. Instalação e configuração de impressora laser da recepção para sala da 3S, configuração e instalação de impressora e scaner. ","type":"servico","unitPrice":250,"price":250,"amount":250,"quantity":1}]	620	250.00	0.00	[{"name":"Serviço ALL In One Dell - Formatação, instalação, atualização e configuração do sistema operacional e programas. Instalação e configuração de impressora laser da recepção para sala da 3S, configuração e instalação de impressora e scaner. ","amount":250,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-02-02 15:22:48.67057	\N	0.00	9
1276	Pegar nobreak	101	277	entrada	230.00	pago	\N	2026-02-02 20:03:15.682	2026-01-13 03:00:00	9	2026-02-02 20:03:16.771	9	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Nobreak - Diagnóstico e resolução. Troca da bateria 12/7 nobreak + limpeza interna.: R$ 80,00\n\nProdutos/Materiais:\n- Bateria Intelbras nobreak 12/7 ( 1 ano garantia ): R$ 150,00\n\n[{"name":"Nobreak - Diagnóstico e resolução. Troca da bateria 12/7 nobreak + limpeza interna.","description":"Nobreak - Diagnóstico e resolução. Troca da bateria 12/7 nobreak + limpeza interna.","type":"servico","unitPrice":80,"price":80,"amount":80,"quantity":1},{"name":"Bateria Intelbras nobreak 12/7 ( 1 ano garantia )","description":"Bateria Intelbras nobreak 12/7 ( 1 ano garantia )","type":"produto","unitPrice":150,"price":150,"amount":150,"quantity":1}]	574	80.00	150.00	[{"name":"Nobreak - Diagnóstico e resolução. Troca da bateria 12/7 nobreak + limpeza interna.","amount":80,"quantity":1,"type":"servico"}]	[{"name":"Bateria Intelbras nobreak 12/7 ( 1 ano garantia )","amount":150,"quantity":1,"type":"produto"}]	\N	\N	2026-01-13 03:00:00	\N	0.00	9
1316	Ativáção windows Alvanize	56	\N	entrada	50.00	pendente	\N	\N	2026-02-02 20:07:33.914	9	2026-02-02 17:07:33.91907	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Acesso remoto para fazer ativação do windows notebook Eventos. : R$ 50,00\n\n[{"name":"Acesso remoto para fazer ativação do windows notebook Eventos. ","description":"Acesso remoto para fazer ativação do windows notebook Eventos. ","type":"servico","unitPrice":50,"price":50,"amount":50,"quantity":1}]	627	50.00	0.00	[{"name":"Acesso remoto para fazer ativação do windows notebook Eventos. ","amount":50,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-02-02 17:07:33.91907	\N	0.00	9
1317	Verificar nobreak Camila. Apitando. 	25	320	entrada	230.00	pendente	\N	\N	2026-02-03 16:08:42.924	9	2026-02-03 13:08:42.928292	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para substituição da bateria do nobreak gerencia. : R$ 80,00\n\nProdutos/Materiais:\n- Bateria Intelbras 12v/7a P/ Nobreak ( 1 Ano Garantia ): R$ 150,00\n\n[{"name":"Visita técnica para substituição da bateria do nobreak gerencia. ","description":"Visita técnica para substituição da bateria do nobreak gerencia. ","type":"servico","unitPrice":80,"price":80,"amount":80,"quantity":1},{"name":"Bateria Intelbras 12v/7a P/ Nobreak ( 1 Ano Garantia )","description":"Bateria Intelbras 12v/7a P/ Nobreak ( 1 Ano Garantia )","type":"produto","unitPrice":150,"price":150,"amount":150,"quantity":1}]	633	80.00	150.00	[{"name":"Visita técnica para substituição da bateria do nobreak gerencia. ","amount":80,"quantity":1,"type":"servico"}]	[{"name":"Bateria Intelbras 12v/7a P/ Nobreak ( 1 Ano Garantia )","amount":150,"quantity":1,"type":"produto"}]	\N	\N	2026-02-03 13:08:42.928292	\N	0.00	9
1318	Cam servidor	25	\N	entrada	100.00	pendente	\N	\N	2026-01-28 03:00:00	9	2026-02-03 16:10:58.413	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica com urgência para verificar servidor que não estava ligando após queda de energia. Foi identificado que a bateria da CMOS da placa mãe precisava ser substituída. Bateria substituída e problema resolvido.: R$ 100,00\n\n[{"name":"Visita técnica com urgência para verificar servidor que não estava ligando após queda de energia. Foi identificado que a bateria da CMOS da placa mãe precisava ser substituída. Bateria substituída e problema resolvido.","description":"Visita técnica com urgência para verificar servidor que não estava ligando após queda de energia. Foi identificado que a bateria da CMOS da placa mãe precisava ser substituída. Bateria substituída e problema resolvido.","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	621	100.00	0.00	[{"name":"Visita técnica com urgência para verificar servidor que não estava ligando após queda de energia. Foi identificado que a bateria da CMOS da placa mãe precisava ser substituída. Bateria substituída e problema resolvido.","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-28 03:00:00	\N	0.00	9
1280	Visita técnica desktop gerente.	25	\N	entrada	100.00	pago	\N	2026-02-03 16:12:47.172	2026-01-21 13:48:59.236	9	2026-02-03 16:12:47.865	9	\N	\N	\N	\N	Visita técnica desktop gerente.\n\nDiscriminação de valores:\n\nServiços:\n- Visita técnica para analisar desktop da gerencia. Oxidações na memória RAM. Limpeza e desoxidação. : R$ 100,00\n\n[{"name":"Visita técnica para analisar desktop da gerencia. Oxidações na memória RAM. Limpeza e desoxidação. ","description":"Visita técnica para analisar desktop da gerencia. Oxidações na memória RAM. Limpeza e desoxidação. ","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	589	100.00	0.00	[{"name":"Visita técnica para analisar desktop da gerencia. Oxidações na memória RAM. Limpeza e desoxidação. ","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-21 13:48:59.259829	\N	0.00	9
1319	Verificar Pc do teleatendimento. 	8	293	entrada	100.00	pendente	\N	\N	2026-01-13 03:00:00	9	2026-02-03 19:42:45.766	\N	\N	\N	\N	\N	Discriminação de valores:\n\nServiços:\n- Visita técnica para trocar a fonte de alimentação de um dos computadores do TeleAtendimento. Pc ao lado de Renata.  Fonte foi tirada do Coringa que está sendo usado de doador. : R$ 100,00\n\n[{"name":"Visita técnica para trocar a fonte de alimentação de um dos computadores do TeleAtendimento. Pc ao lado de Renata.  Fonte foi tirada do Coringa que está sendo usado de doador. ","description":"Visita técnica para trocar a fonte de alimentação de um dos computadores do TeleAtendimento. Pc ao lado de Renata.  Fonte foi tirada do Coringa que está sendo usado de doador. ","type":"servico","unitPrice":100,"price":100,"amount":100,"quantity":1}]	634	100.00	0.00	[{"name":"Visita técnica para trocar a fonte de alimentação de um dos computadores do TeleAtendimento. Pc ao lado de Renata.  Fonte foi tirada do Coringa que está sendo usado de doador. ","amount":100,"quantity":1,"type":"servico"}]	[]	\N	\N	2026-01-13 03:00:00	\N	0.00	9
\.


--
-- Data for Name: history_events; Type: TABLE DATA; Schema: public; Owner: -
--
...
1702	314	\N	\N	call_created	Chamado criado: 	1	\N	2026-01-27 23:56:22.033809
...
1637	298	587	\N	service_updated	Serviço #587 atualizado	9	{"serviceId":587}	2026-01-20 15:53:03.521133
1638	299	586	\N	service_updated	Serviço #586 atualizado	9	{"serviceId":586}	2026-01-20 15:55:37.882061
1639	307	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-20 16:05:23.22423
1640	\N	\N	\N	client_created	Cliente Mikhael AMTM criado	9	{"clientId":183,"clientName":"Mikhael AMTM"}	2026-01-20 16:06:44.882332
1641	308	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-20 16:07:10.260892
1642	273	\N	1278	payment_received	Pagamento recebido: Parcela 2 - Manutenção nos três computadores do escritório	1	\N	2026-01-20 18:30:52.979697
1643	309	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-21 13:42:30.653561
1644	310	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-21 13:42:58.424202
1645	279	557	\N	service_updated	Serviço #557 atualizado	9	{"serviceId":557}	2026-01-21 13:44:56.614613
1646	279	557	1279	converted_to_financial	Serviço convertido para faturamento: Verificar notebook.  	9	\N	2026-01-21 13:45:24.020602
1647	279	557	\N	service_deleted	Serviço #557 deletado	9	{"serviceId":557}	2026-01-21 13:45:26.005947
1648	\N	589	\N	service_created	Serviço criado: Visita técnica desktop gerente.	9	\N	2026-01-21 13:47:31.799713
1649	\N	589	\N	service_updated	Serviço #589 atualizado	9	{"serviceId":589}	2026-01-21 13:47:58.46085
1725	315	\N	\N	call_created	Chamado criado: 	6	\N	2026-01-28 12:21:24.250765
1650	\N	589	\N	service_updated	Serviço #589 atualizado	9	{"serviceId":589}	2026-01-21 13:48:51.118565
1651	\N	589	1280	converted_to_financial	Serviço convertido para faturamento: Visita técnica desktop gerente.	9	\N	2026-01-21 13:48:59.302436
1652	\N	589	\N	service_deleted	Serviço #589 deletado	9	{"serviceId":589}	2026-01-21 13:49:01.245874
1653	\N	590	\N	service_created	Serviço criado: Acesso remoto instalar impressora recepção. 	9	\N	2026-01-21 13:50:04.393975
1654	\N	590	\N	service_updated	Serviço #590 atualizado	9	{"serviceId":590}	2026-01-21 13:50:44.554067
1655	\N	590	\N	service_updated	Serviço #590 atualizado	9	{"serviceId":590}	2026-01-21 13:51:03.658405
1656	\N	590	1281	converted_to_financial	Serviço convertido para faturamento: Acesso remoto instalar impressora recepção. 	9	\N	2026-01-21 13:51:12.452354
1657	\N	590	\N	service_deleted	Serviço #590 deletado	9	{"serviceId":590}	2026-01-21 13:51:14.369577
1658	\N	591	\N	service_created	Serviço criado: Acesso remoto para configurar pasta do servidor em um notebook que perdeu a conexão com o servidor. 	9	\N	2026-01-21 13:52:37.877089
1659	\N	591	\N	service_updated	Serviço #591 atualizado	9	{"serviceId":591}	2026-01-21 13:53:00.712053
1660	\N	591	\N	service_updated	Serviço #591 atualizado	9	{"serviceId":591}	2026-01-21 13:53:42.137619
1661	\N	591	1282	converted_to_financial	Serviço convertido para faturamento: Acesso remoto para configurar pasta do servidor em um notebook que perdeu a conexão com o servidor. 	9	\N	2026-01-21 13:53:55.227989
1662	\N	591	\N	service_deleted	Serviço #591 deletado	9	{"serviceId":591}	2026-01-21 13:53:57.191331
1663	\N	\N	1283	converted_to_financial	Serviço convertido para faturamento: Sorvetin	1	\N	2026-01-21 14:57:17.08128
1664	\N	\N	1283	payment_received	Pagamento recebido: Sorvetin	1	\N	2026-01-21 14:57:27.427695
1665	\N	\N	1284	converted_to_financial	Serviço convertido para faturamento: SSD 256 nvme + RAM 8gb DDR sodim gordinho Charles	1	\N	2026-01-21 18:22:19.082628
1666	\N	\N	1284	payment_received	Pagamento recebido: SSD 256 nvme + RAM 8gb DDR sodim gordinho Charles	1	\N	2026-01-21 18:22:28.326606
1667	\N	591	1282	transaction_deleted	Transação #1282 deletada - R$ 50.00	9	{"transactionId":1282,"amount":"50.00"}	2026-01-21 18:25:17.293937
1668	\N	565	\N	service_updated	Serviço #565 atualizado	9	{"serviceId":565}	2026-01-21 19:10:19.279698
1669	\N	565	1285	converted_to_financial	Serviço convertido para faturamento: Manutenção dois desktop Rômulo.	9	\N	2026-01-21 19:10:26.180044
1670	\N	565	\N	service_deleted	Serviço #565 deletado	9	{"serviceId":565}	2026-01-21 19:10:28.557266
1671	\N	565	1285	discount_applied	Desconto de R$ 100,00 aplicado à transação #1285	9	{"transactionId":1285,"discount":100,"originalAmount":500,"newAmount":400}	2026-01-21 19:10:39.921162
1672	309	\N	\N	call_updated	Chamado #309 atualizado	9	{"callId":309}	2026-01-22 12:26:09.059731
1673	309	592	\N	converted_to_service	Chamado convertido em serviço: Assessoria para resolver espelhamento de tela do notebook home office para monitor. \nInstalação de Pc novo na recepção. \n\nMonitor na assistência para analisar. 	9	\N	2026-01-22 12:26:16.415918
1674	310	\N	\N	call_updated	Chamado #310 atualizado	9	{"callId":310}	2026-01-22 12:26:33.599852
1675	310	593	\N	converted_to_service	Chamado convertido em serviço: Desktop na assistência para fazer limpeza. 	9	\N	2026-01-22 12:26:42.69409
1676	305	594	\N	converted_to_service	Chamado convertido em serviço: Instalar IMP no escritório	9	\N	2026-01-22 12:26:55.917494
1677	304	595	\N	converted_to_service	Chamado convertido em serviço: Verificar problema na rede. 	9	\N	2026-01-22 12:27:00.967104
1678	300	\N	\N	call_deleted	Chamado #300 deletado	9	{"callId":300}	2026-01-22 12:27:19.229969
1679	295	596	\N	converted_to_service	Chamado convertido em serviço: Verificar emails e lentidão no Pc. 	9	\N	2026-01-22 12:27:51.209316
1680	311	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-22 12:30:37.84163
1681	312	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-22 12:31:02.552604
1682	\N	\N	\N	client_created	Cliente Plínio Sa  criado	9	{"clientId":184,"clientName":"Plínio Sa "}	2026-01-22 12:35:16.022558
1683	313	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-22 12:35:30.965931
1684	313	597	\N	converted_to_service	Chamado convertido em serviço: Note na assistência para verificar lentidão. 	9	\N	2026-01-22 12:35:37.544277
1685	298	587	1287	converted_to_financial	Serviço convertido para faturamento: Cameras da casa 	9	\N	2026-01-22 16:11:27.139427
1686	298	587	\N	service_deleted	Serviço #587 deletado	9	{"serviceId":587}	2026-01-22 16:11:29.122814
1687	299	586	\N	service_updated	Serviço #586 atualizado	9	{"serviceId":586}	2026-01-22 16:12:33.241663
1688	299	586	1288	converted_to_financial	Serviço convertido para faturamento: Desktop pra analisar. 	9	\N	2026-01-22 16:12:43.210707
1689	299	586	\N	service_deleted	Serviço #586 deletado	9	{"serviceId":586}	2026-01-22 16:12:45.125185
1690	\N	598	\N	service_created	Serviço criado: Manutenção preventiva e reinstalação de sistema operacional e atualizações	1	\N	2026-01-22 21:48:01.743056
1691	\N	598	\N	service_updated	Serviço #598 atualizado	1	{"serviceId":598}	2026-01-22 21:50:52.462208
1692	\N	598	\N	service_updated	Serviço #598 atualizado	1	{"serviceId":598}	2026-01-22 21:51:24.035256
1693	\N	\N	1289	payment_received	Pagamento recebido: PGTO Cartão mercado Pago:\n7/10 Bomba dagua cultivo 34 + 1/14 Escada 53 + concret canaletas 16,50 + 1/18 Mikrotiks 54 + flat imp Dr Dirceu 48.	9	\N	2026-01-23 00:22:23.387723
1694	109	455	\N	service_deleted	Serviço #455 deletado	9	{"serviceId":455}	2026-01-23 00:53:30.670334
1695	241	532	\N	service_deleted	Serviço #532 deletado	9	{"serviceId":532}	2026-01-23 00:53:41.690291
1696	\N	599	\N	service_created	Serviço criado: Rede e telefonia	9	\N	2026-01-23 01:21:35.363059
1697	\N	599	\N	service_updated	Serviço #599 atualizado	9	{"serviceId":599}	2026-01-23 01:24:29.789789
1698	267	\N	\N	call_updated	Chamado #267 atualizado	9	{"callId":267}	2026-01-27 23:52:16.652579
1699	267	600	\N	converted_to_service	Chamado convertido em serviço: Visita técnica para verificar instalação da infra do apartamento novo. \nConjunto de máquinas para fazer manutenção e testes. 	9	\N	2026-01-27 23:52:21.354084
1700	301	\N	\N	call_deleted	Chamado #301 deletado	9	{"callId":301}	2026-01-27 23:52:52.866724
1701	312	601	\N	converted_to_service	Chamado convertido em serviço: Colocar bateria da CMOS em uma máquina. 	9	\N	2026-01-27 23:52:58.118774
1703	\N	602	\N	service_created	Serviço criado: Instalação do No-break balcão	6	\N	2026-01-28 11:43:23.272627
1704	\N	602	\N	service_updated	Serviço #602 atualizado	6	{"serviceId":602}	2026-01-28 11:45:57.061553
1705	\N	602	1290	converted_to_financial	Serviço convertido para faturamento: Instalação do No-break balcão	6	\N	2026-01-28 11:46:01.82304
1706	\N	602	\N	service_deleted	Serviço #602 deletado	6	{"serviceId":602}	2026-01-28 11:46:01.864608
1707	\N	603	\N	service_created	Serviço criado: Sistema fora do ar	6	\N	2026-01-28 11:47:56.305235
1708	\N	603	\N	service_updated	Serviço #603 atualizado	6	{"serviceId":603}	2026-01-28 11:48:44.319797
1709	\N	603	1291	converted_to_financial	Serviço convertido para faturamento: Sistema fora do ar	6	\N	2026-01-28 11:48:51.228179
1710	\N	603	\N	service_deleted	Serviço #603 deletado	6	{"serviceId":603}	2026-01-28 11:48:51.279155
1711	\N	604	\N	service_created	Serviço criado: Reparo no nobreak do servidor	6	\N	2026-01-28 11:50:31.890914
1712	\N	521	1229	transaction_deleted	Transação #1229 deletada - R$ 380.00	1	{"transactionId":1229,"amount":"380.00"}	2026-01-28 11:50:31.933577
1713	\N	604	\N	service_updated	Serviço #604 atualizado	6	{"serviceId":604}	2026-01-28 11:50:59.950622
1714	\N	604	1292	converted_to_financial	Serviço convertido para faturamento: Reparo no nobreak do servidor	6	\N	2026-01-28 11:51:03.595725
1715	\N	604	\N	service_deleted	Serviço #604 deletado	6	{"serviceId":604}	2026-01-28 11:51:03.646524
1716	\N	605	\N	service_created	Serviço criado: Suporte remoto	6	\N	2026-01-28 12:06:05.722361
1717	\N	605	\N	service_updated	Serviço #605 atualizado	6	{"serviceId":605}	2026-01-28 12:06:46.427069
1718	\N	605	1293	converted_to_financial	Serviço convertido para faturamento: Suporte remoto	6	\N	2026-01-28 12:06:50.08024
1719	\N	605	\N	service_deleted	Serviço #605 deletado	6	{"serviceId":605}	2026-01-28 12:06:50.129527
1720	\N	606	\N	service_created	Serviço criado: Reparo CPU antiga do balcão	6	\N	2026-01-28 12:13:16.738303
1721	\N	606	\N	service_updated	Serviço #606 atualizado	6	{"serviceId":606}	2026-01-28 12:14:38.703918
1722	\N	606	\N	service_updated	Serviço #606 atualizado	6	{"serviceId":606}	2026-01-28 12:15:00.491508
1723	\N	606	\N	service_updated	Serviço #606 atualizado	6	{"serviceId":606}	2026-01-28 12:20:18.881026
1724	259	\N	\N	call_deleted	Chamado #259 deletado	6	{"callId":259}	2026-01-28 12:20:43.632221
1726	\N	\N	1294	converted_to_financial	Serviço convertido para faturamento: Compra das câmeras 	1	\N	2026-01-28 13:55:22.426012
1727	\N	607	\N	service_created	Serviço criado: Pc entregas	9	\N	2026-01-28 18:47:50.26673
1728	\N	607	\N	service_updated	Serviço #607 atualizado	9	{"serviceId":607}	2026-01-28 18:51:04.492486
1729	\N	607	1295	converted_to_financial	Serviço convertido para faturamento: Pc entregas	9	\N	2026-01-28 18:51:21.35825
1730	\N	607	\N	service_deleted	Serviço #607 deletado	9	{"serviceId":607}	2026-01-28 18:51:21.409146
1731	\N	599	1296	converted_to_financial	Serviço convertido para faturamento: Rede e telefonia	9	\N	2026-01-28 18:51:28.834588
1732	\N	599	\N	service_deleted	Serviço #599 deletado	9	{"serviceId":599}	2026-01-28 18:51:28.876952
1733	283	608	\N	converted_to_service	Chamado convertido em serviço: Nobreak recepção e do servidor João da escooasia	9	\N	2026-01-28 18:53:55.045922
1734	294	609	\N	converted_to_service	Chamado convertido em serviço: Medical center  Pc não liga. 	9	\N	2026-01-28 18:54:30.670349
1735	283	608	\N	service_updated	Serviço #608 atualizado	9	{"serviceId":608}	2026-01-28 18:57:54.978191
1736	283	608	\N	service_updated	Serviço #608 atualizado	9	{"serviceId":608}	2026-01-28 19:00:20.906227
1737	283	608	\N	service_updated	Serviço #608 atualizado	9	{"serviceId":608}	2026-01-28 19:00:34.451433
1738	283	608	1297	converted_to_financial	Serviço convertido para faturamento: Nobreak recepção e do servidor João da escooasia	9	\N	2026-01-28 19:00:41.926713
1739	283	608	\N	service_deleted	Serviço #608 deletado	9	{"serviceId":608}	2026-01-28 19:00:41.977334
1740	294	609	\N	service_updated	Serviço #609 atualizado	9	{"serviceId":609}	2026-01-28 19:04:08.448903
1741	294	609	1298	converted_to_financial	Serviço convertido para faturamento: Medical center  Pc não liga. 	9	\N	2026-01-28 19:04:12.586187
1742	294	609	\N	service_deleted	Serviço #609 deletado	9	{"serviceId":609}	2026-01-28 19:04:12.686157
1743	105	\N	1204	payment_received	Pagamento recebido: Parcela 1 - Obra medical center. Desmontagem e passagem dos novos cabos para efetuar obra. Remontagem de equipamentos após obra. Só falta agora colocar as 4 câmeras pra funcionar. Foram usados 200 metros de cabo. 2 canaletas. 4 câmeras recepção e faixada.	9	\N	2026-01-28 19:06:44.717174
1744	105	\N	1252	transaction_deleted	Transação #1252 deletada - R$ 519.60	9	{"transactionId":1252,"amount":"519.60"}	2026-01-28 16:28:29.894939
1745	105	\N	1251	transaction_deleted	Transação #1251 deletada - R$ 519.60	9	{"transactionId":1251,"amount":"519.60"}	2026-01-28 16:28:35.917151
1746	105	\N	1250	transaction_deleted	Transação #1250 deletada - R$ 519.60	9	{"transactionId":1250,"amount":"519.60"}	2026-01-28 16:28:42.895066
1747	105	\N	1204	transaction_deleted	Transação #1204 deletada - R$ 519.60	9	{"transactionId":1204,"amount":"519.60"}	2026-01-28 16:29:26.575597
1748	\N	610	\N	service_created	Serviço criado: Medical center monitor	9	\N	2026-01-28 16:32:10.999184
1749	\N	610	\N	service_updated	Serviço #610 atualizado	9	{"serviceId":610}	2026-01-28 16:33:48.932389
1750	\N	610	1299	converted_to_financial	Serviço convertido para faturamento: Medical center monitor	9	\N	2026-01-28 16:33:56.338727
1751	\N	610	\N	service_deleted	Serviço #610 deletado	9	{"serviceId":610}	2026-01-28 16:33:57.830314
1752	\N	611	\N	service_created	Serviço criado: Rede e telefonia	9	\N	2026-01-28 16:43:16.818203
1753	\N	599	1296	transaction_deleted	Transação #1296 deletada - R$ 875.00	1	{"transactionId":1296,"amount":"875.00"}	2026-01-28 16:43:18.65952
1754	\N	611	\N	service_updated	Serviço #611 atualizado	9	{"serviceId":611}	2026-01-28 16:44:33.793582
1755	\N	611	1300	converted_to_financial	Serviço convertido para faturamento: Rede e telefonia	9	\N	2026-01-28 16:44:43.103044
1756	\N	611	\N	service_deleted	Serviço #611 deletado	9	{"serviceId":611}	2026-01-28 16:44:44.582994
1757	311	612	\N	converted_to_service	Chamado convertido em serviço: Visita técnica para verificar impressora e notebook da Dra. 	9	\N	2026-01-28 21:33:12.850546
1758	306	613	\N	converted_to_service	Chamado convertido em serviço: Verificar internet chalés. 	9	\N	2026-01-28 21:33:22.062097
1759	302	614	\N	converted_to_service	Chamado convertido em serviço: Impressora Brother não liga, provavelmente foi ligada em 220v	7	\N	2026-01-28 21:33:28.995229
1760	\N	\N	\N	client_created	Cliente Luan criado	9	{"clientId":185,"clientName":"Luan"}	2026-01-28 21:34:15.106981
1761	297	\N	\N	call_updated	Chamado #297 atualizado	9	{"callId":297}	2026-01-28 21:34:19.67245
1762	296	\N	\N	call_updated	Chamado #296 atualizado	9	{"callId":296}	2026-01-28 21:35:06.103949
1763	296	615	\N	converted_to_service	Chamado convertido em serviço: Ajustes nas impressoras Canon.\nSSD 240gb + baixa em ALL in one. \nAjustes em outro ALL in one. 	1	\N	2026-01-28 21:35:12.648364
1764	284	616	\N	converted_to_service	Chamado convertido em serviço: Problema impressora colorida. Pegar pra tentar resolver.  E se tiver uma pra levar pra alugar. 	9	\N	2026-01-28 21:35:40.69767
1765	272	\N	\N	call_deleted	Chamado #272 deletado	9	{"callId":272}	2026-01-28 21:35:58.2793
1767	104	617	\N	service_updated	Serviço #617 atualizado	9	{"serviceId":617}	2026-01-28 21:46:49.659467
1766	104	617	\N	converted_to_service	Chamado convertido em serviço: Pegar máquina para analisar	9	\N	2026-01-28 21:42:56.376666
1768	104	617	\N	service_updated	Serviço #617 atualizado	9	{"serviceId":617}	2026-01-28 21:47:15.126818
1769	255	\N	\N	call_updated	Chamado #255 atualizado	9	{"callId":255}	2026-01-28 22:01:08.341829
1770	284	616	\N	service_updated	Serviço #616 atualizado	9	{"serviceId":616}	2026-01-28 22:02:46.648723
1771	284	616	1301	converted_to_financial	Serviço convertido para faturamento: Problema impressora colorida. Pegar pra tentar resolver.  E se tiver uma pra levar pra alugar. 	9	\N	2026-01-28 22:02:52.633295
1772	284	616	\N	service_deleted	Serviço #616 deletado	9	{"serviceId":616}	2026-01-28 22:02:53.979938
1773	306	613	\N	service_updated	Serviço #613 atualizado	9	{"serviceId":613}	2026-01-28 22:06:27.453776
1774	306	613	1302	converted_to_financial	Serviço convertido para faturamento: Verificar internet chalés. 	9	\N	2026-01-28 22:06:38.54861
1775	306	613	\N	service_deleted	Serviço #613 deletado	9	{"serviceId":613}	2026-01-28 22:06:39.925663
1776	311	612	\N	service_updated	Serviço #612 atualizado	9	{"serviceId":612}	2026-01-28 22:07:44.813064
1777	\N	618	\N	service_created	Serviço criado: Notebook	9	\N	2026-01-28 22:10:32.828103
1778	\N	618	\N	service_updated	Serviço #618 atualizado	9	{"serviceId":618}	2026-01-28 22:13:20.917071
1779	\N	618	1303	converted_to_financial	Serviço convertido para faturamento: Notebook	9	\N	2026-01-28 22:13:27.525817
1780	\N	618	\N	service_deleted	Serviço #618 deletado	9	{"serviceId":618}	2026-01-28 22:13:28.928535
1781	311	612	1304	converted_to_financial	Serviço convertido para faturamento: Visita técnica para verificar impressora e notebook da Dra. 	9	\N	2026-01-28 22:13:34.658581
1782	311	612	\N	service_deleted	Serviço #612 deletado	9	{"serviceId":612}	2026-01-28 22:13:36.273519
1783	295	596	\N	service_updated	Serviço #596 atualizado	9	{"serviceId":596}	2026-01-28 22:15:56.002154
1784	295	596	1305	converted_to_financial	Serviço convertido para faturamento: Verificar emails e lentidão no Pc. 	9	\N	2026-01-28 22:16:07.972647
1785	295	596	\N	service_deleted	Serviço #596 deletado	9	{"serviceId":596}	2026-01-28 22:16:09.788578
1786	304	595	\N	service_updated	Serviço #595 atualizado	9	{"serviceId":595}	2026-01-28 22:17:06.552291
1787	304	595	1306	converted_to_financial	Serviço convertido para faturamento: Verificar problema na rede. 	9	\N	2026-01-28 22:17:18.016729
1788	304	595	\N	service_deleted	Serviço #595 deletado	9	{"serviceId":595}	2026-01-28 22:17:19.472602
1789	305	594	\N	service_updated	Serviço #594 atualizado	9	{"serviceId":594}	2026-01-28 22:20:41.691908
1790	305	594	1307	converted_to_financial	Serviço convertido para faturamento: Instalar IMP no escritório	9	\N	2026-01-28 22:20:57.009765
1791	305	594	\N	service_deleted	Serviço #594 deletado	9	{"serviceId":594}	2026-01-28 22:20:58.668761
1792	310	593	\N	service_deleted	Serviço #593 deletado	9	{"serviceId":593}	2026-01-28 22:21:15.471646
1793	\N	584	\N	service_deleted	Serviço #584 deletado	9	{"serviceId":584}	2026-01-28 22:21:28.551221
1794	\N	583	\N	service_deleted	Serviço #583 deletado	9	{"serviceId":583}	2026-01-28 22:21:50.007098
1795	\N	619	\N	service_created	Serviço criado: Configuração da impressora e Alexa. 	9	\N	2026-01-28 22:23:05.807845
1796	\N	619	\N	service_updated	Serviço #619 atualizado	9	{"serviceId":619}	2026-01-28 22:24:03.25144
1797	\N	619	1308	converted_to_financial	Serviço convertido para faturamento: Configuração da impressora e Alexa. 	9	\N	2026-01-28 22:24:14.057789
1798	\N	619	\N	service_deleted	Serviço #619 deletado	9	{"serviceId":619}	2026-01-28 22:24:15.416569
1799	\N	530	1309	converted_to_financial	Serviço convertido para faturamento: Mikrotik Failover e Loadbalance.	9	\N	2026-01-28 22:24:59.039993
1800	\N	530	\N	service_deleted	Serviço #530 deletado	9	{"serviceId":530}	2026-01-28 22:25:00.409901
1801	261	541	\N	service_deleted	Serviço #541 deletado	9	{"serviceId":541}	2026-01-28 22:25:07.232761
1802	262	542	\N	service_deleted	Serviço #542 deletado	9	{"serviceId":542}	2026-01-28 22:25:20.978805
1803	295	308	\N	service_deleted	Serviço #308 deletado	9	{"serviceId":308}	2026-01-28 22:25:44.603046
1804	\N	553	\N	service_deleted	Serviço #553 deletado	9	{"serviceId":553}	2026-01-28 22:26:17.183316
1805	269	551	\N	service_deleted	Serviço #551 deletado	9	{"serviceId":551}	2026-01-28 22:26:33.010181
1806	253	558	1268	payment_received	Pagamento recebido: Note Kew tá com Claudinho pra adapta botão. 	9	\N	2026-01-28 22:28:15.031647
1807	276	555	1244	payment_received	Pagamento recebido: Verificar notebook 	9	\N	2026-01-28 22:28:38.478311
1808	\N	620	\N	service_created	Serviço criado: ALL in one baixa	9	\N	2026-01-28 22:30:31.352358
1809	\N	\N	\N	client_created	Cliente Paiva Refrigeração criado	9	{"clientId":186,"clientName":"Paiva Refrigeração"}	2026-01-28 22:31:28.756016
1810	316	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-28 22:31:34.567468
1811	\N	621	\N	service_created	Serviço criado: Cam servidor	9	\N	2026-01-28 22:32:46.617156
1812	\N	622	\N	service_created	Serviço criado: Odete ultrassom urgente	9	\N	2026-01-28 22:33:06.707512
1813	\N	623	\N	service_created	Serviço criado: Manutenção impressora recepção	9	\N	2026-01-28 22:33:50.188324
1814	\N	623	\N	service_updated	Serviço #623 atualizado	9	{"serviceId":623}	2026-01-28 22:35:55.36922
1815	317	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-29 09:46:02.346152
1816	314	624	\N	converted_to_service	Chamado convertido em serviço: Nobreak do servidor apitando e com cooler parado	1	\N	2026-01-29 09:47:43.620521
1817	318	\N	\N	call_created	Chamado criado: 	1	\N	2026-01-29 09:48:36.601219
1818	314	624	\N	service_updated	Serviço #624 atualizado	1	{"serviceId":624}	2026-01-29 09:51:57.44201
1819	\N	598	\N	service_updated	Serviço #598 atualizado	1	{"serviceId":598}	2026-01-29 10:09:33.434072
1820	319	\N	\N	call_created	Chamado criado: 	9	\N	2026-01-29 12:23:19.607891
1821	\N	585	\N	service_updated	Serviço #585 atualizado	1	{"serviceId":585}	2026-01-29 14:42:45.422318
1822	\N	585	1310	converted_to_financial	Serviço convertido para faturamento: Substituição de Armazenamento (SSD)	7	\N	2026-01-29 18:11:16.772635
1823	\N	585	\N	service_deleted	Serviço #585 deletado	1	{"serviceId":585}	2026-01-29 18:11:18.344566
1824	\N	585	1310	payment_received	Pagamento recebido: Substituição de Armazenamento (SSD)	1	\N	2026-01-29 18:11:29.029976
1825	315	625	\N	converted_to_service	Chamado convertido em serviço: Reposição bateria do nobreak da Jangada Veículos	6	\N	2026-01-30 17:07:48.139582
1826	315	625	\N	service_updated	Serviço #625 atualizado	1	{"serviceId":625}	2026-01-30 17:08:42.335229
1827	315	625	1311	converted_to_financial	Serviço convertido para faturamento: Reposição bateria do nobreak da Jangada Veículos	6	\N	2026-01-30 17:08:50.0441
1828	315	625	\N	service_deleted	Serviço #625 deletado	1	{"serviceId":625}	2026-01-30 17:08:51.358184
1829	315	625	1311	payment_received	Pagamento recebido: Reposição bateria do nobreak da Jangada Veículos	1	\N	2026-01-30 17:08:59.656874
1830	318	626	\N	converted_to_service	Chamado convertido em serviço: Reposição da fonte de alimentação do servidor.	1	\N	2026-01-31 22:25:17.284043
1831	292	\N	\N	call_deleted	Chamado #292 deletado	1	{"callId":292}	2026-01-31 22:25:50.293237
1832	314	624	1312	converted_to_financial	Serviço convertido para faturamento: Nobreak do servidor apitando e com cooler parado	1	\N	2026-01-31 22:26:23.961316
1833	314	624	\N	service_deleted	Serviço #624 deletado	1	{"serviceId":624}	2026-01-31 22:26:25.586439
1834	318	626	\N	service_updated	Serviço #626 atualizado	1	{"serviceId":626}	2026-01-31 22:27:21.472401
1835	318	626	1313	converted_to_financial	Serviço convertido para faturamento: Reposição da fonte de alimentação do servidor.	1	\N	2026-01-31 22:27:32.814218
1836	318	626	\N	service_deleted	Serviço #626 deletado	1	{"serviceId":626}	2026-01-31 22:27:34.550883
1837	296	615	\N	service_deleted	Serviço #615 deletado	1	{"serviceId":615}	2026-01-31 22:28:22.535469
1838	\N	623	1314	converted_to_financial	Serviço convertido para faturamento: Manutenção impressora recepção	9	\N	2026-02-02 15:20:08.869313
1839	\N	623	\N	service_deleted	Serviço #623 deletado	9	{"serviceId":623}	2026-02-02 15:20:10.660579
1840	\N	620	\N	service_updated	Serviço #620 atualizado	9	{"serviceId":620}	2026-02-02 15:22:38.393885
1841	\N	620	1315	converted_to_financial	Serviço convertido para faturamento: ALL in one baixa	9	\N	2026-02-02 15:22:48.722824
1842	\N	620	\N	service_deleted	Serviço #620 deletado	9	{"serviceId":620}	2026-02-02 15:22:50.159281
1843	\N	622	\N	service_updated	Serviço #622 atualizado	9	{"serviceId":622}	2026-02-02 15:29:13.285811
1844	\N	611	1300	discount_applied	Desconto de R$ 25,00 aplicado à transação #1300	9	{"transactionId":1300,"discount":25,"originalAmount":875,"newAmount":850}	2026-02-02 16:54:22.139052
1845	\N	611	1300	payment_received	Pagamento recebido: Rede e telefonia	9	\N	2026-02-02 16:54:31.422311
1846	105	\N	1249	payment_received	Pagamento recebido: Parcela 2 - Obra medical center. Desmontagem e passagem dos novos cabos para efetuar obra. Remontagem de equipamentos após obra. Só falta agora colocar as 4 câmeras pra funcionar. Foram usados 200 metros de cabo. 2 canaletas. 4 câmeras recepção e faixada.	9	\N	2026-02-02 17:02:26.518637
1847	277	574	1276	payment_received	Pagamento recebido: Pegar nobreak	9	\N	2026-02-02 17:03:16.822093
1848	\N	627	\N	service_created	Serviço criado: Ativáção windows Alvanize	9	\N	2026-02-02 17:06:53.401867
1849	\N	627	\N	service_updated	Serviço #627 atualizado	9	{"serviceId":627}	2026-02-02 17:07:28.485996
1850	\N	627	1316	converted_to_financial	Serviço convertido para faturamento: Ativáção windows Alvanize	9	\N	2026-02-02 17:07:33.971555
1851	\N	627	\N	service_deleted	Serviço #627 deletado	9	{"serviceId":627}	2026-02-02 17:07:35.363366
1852	317	\N	\N	call_deleted	Chamado #317 deletado	9	{"callId":317}	2026-02-03 09:28:10.876062
1853	316	628	\N	converted_to_service	Chamado convertido em serviço: Pc lento	9	\N	2026-02-03 09:28:29.10421
1854	308	629	\N	converted_to_service	Chamado convertido em serviço: Verificar DVR e instalação de câmera nova.\nLevar câmeras, cartão de memória e fonte de alimentação.	9	\N	2026-02-03 09:28:40.752078
1855	320	\N	\N	call_created	Chamado criado: 	9	\N	2026-02-03 09:29:03.674017
1856	316	628	\N	service_updated	Serviço #628 atualizado	9	{"serviceId":628}	2026-02-03 09:35:48.205916
1857	321	\N	\N	call_created	Chamado criado: 	9	\N	2026-02-03 10:07:23.357412
1858	\N	630	\N	service_created	Serviço criado: Acesso remoto Luana	9	\N	2026-02-03 10:08:25.529087
1859	\N	631	\N	service_created	Serviço criado: Acesso Zoraide verificar Pc 	9	\N	2026-02-03 10:08:50.819605
1860	321	632	\N	converted_to_service	Chamado convertido em serviço: Pegar note pra verificar tela. 	9	\N	2026-02-03 12:59:11.832088
1861	320	633	\N	converted_to_service	Chamado convertido em serviço: Verificar nobreak Camila. Apitando. 	9	\N	2026-02-03 13:00:14.680166
1862	320	633	\N	service_updated	Serviço #633 atualizado	9	{"serviceId":633}	2026-02-03 13:07:59.651602
1863	320	633	\N	service_updated	Serviço #633 atualizado	9	{"serviceId":633}	2026-02-03 13:08:05.738394
1864	320	633	1317	converted_to_financial	Serviço convertido para faturamento: Verificar nobreak Camila. Apitando. 	9	\N	2026-02-03 13:08:43.003977
1865	320	633	\N	service_deleted	Serviço #633 deletado	9	{"serviceId":633}	2026-02-03 13:08:44.362729
1866	\N	621	\N	service_updated	Serviço #621 atualizado	9	{"serviceId":621}	2026-02-03 13:10:27.914602
1867	\N	621	1318	converted_to_financial	Serviço convertido para faturamento: Cam servidor	9	\N	2026-02-03 13:10:35.044188
1868	\N	621	\N	service_deleted	Serviço #621 deletado	9	{"serviceId":621}	2026-02-03 13:10:37.214942
1869	\N	589	1280	payment_received	Pagamento recebido: Visita técnica desktop gerente.	9	\N	2026-02-03 13:12:47.921519
1870	279	557	1279	payment_received	Pagamento recebido: Verificar notebook.  	9	\N	2026-02-03 13:12:53.275931
1871	\N	590	1281	payment_received	Pagamento recebido: Acesso remoto instalar impressora recepção. 	9	\N	2026-02-03 13:13:08.078303
1872	308	629	\N	service_updated	Serviço #629 atualizado	9	{"serviceId":629}	2026-02-03 13:57:03.061825
1873	293	634	\N	converted_to_service	Chamado convertido em serviço: Verificar Pc do teleatendimento. 	9	\N	2026-02-03 16:38:14.355676
1874	293	634	\N	service_updated	Serviço #634 atualizado	9	{"serviceId":634}	2026-02-03 16:42:10.5555
1875	293	634	1319	converted_to_financial	Serviço convertido para faturamento: Verificar Pc do teleatendimento. 	9	\N	2026-02-03 16:42:31.241216
1876	293	634	\N	service_deleted	Serviço #634 deletado	9	{"serviceId":634}	2026-02-03 16:42:32.921004
1877	322	\N	\N	call_created	Chamado criado: 	9	\N	2026-02-03 16:45:19.849553
1878	322	\N	\N	call_updated	Chamado #322 atualizado	9	{"callId":322}	2026-02-03 16:45:35.448027
1879	268	547	\N	service_updated	Serviço #547 atualizado	9	{"serviceId":547}	2026-02-03 17:01:33.824466
1880	268	547	1320	converted_to_financial	Serviço convertido para faturamento: Manutenção servidor loja santo Antônio	9	\N	2026-02-03 17:01:48.061631
1881	268	547	\N	service_deleted	Serviço #547 deletado	9	{"serviceId":547}	2026-02-03 17:01:49.763987
1882	274	550	\N	service_updated	Serviço #550 atualizado	9	{"serviceId":550}	2026-02-03 17:05:32.14928
1883	274	550	1321	converted_to_financial	Serviço convertido para faturamento: Problemas rede cabeada. Levar um Switch. 	9	\N	2026-02-03 17:05:44.631611
1884	274	550	\N	service_deleted	Serviço #550 deletado	9	{"serviceId":550}	2026-02-03 17:05:45.99354
1885	\N	\N	\N	client_created	Cliente Jonas ForróDos3 criado	9	{"clientId":187,"clientName":"Jonas ForróDos3"}	2026-02-04 10:35:37.777741
1886	323	\N	\N	call_created	Chamado criado: 	9	\N	2026-02-04 10:35:59.310781
1887	\N	630	\N	service_updated	Serviço #630 atualizado	9	{"serviceId":630}	2026-02-04 10:37:36.680773
1888	\N	631	\N	service_updated	Serviço #631 atualizado	9	{"serviceId":631}	2026-02-04 10:38:13.271339
1889	\N	635	\N	service_created	Serviço criado: Note Rômulo	9	\N	2026-02-04 10:41:33.677109
1890	\N	636	\N	service_created	Serviço criado: Popo bateria note	9	\N	2026-02-04 10:42:02.28018
1891	\N	637	\N	service_created	Serviço criado: Reparo dobradiça e tela 	9	\N	2026-02-04 11:11:16.545453
1892	\N	637	\N	service_updated	Serviço #637 atualizado	9	{"serviceId":637}	2026-02-04 11:15:41.852692
1893	\N	637	\N	service_updated	Serviço #637 atualizado	9	{"serviceId":637}	2026-02-04 11:17:03.213715
\.
...
32	1	saida	1	service_606	Utilizado no cliente: Mastercar	2026-01-28 12:14:38.735812
33	1	saida	1	service_626	Utilizado no cliente: UTI da retro	2026-01-31 22:27:22.971309
\.


--
-- Data for Name: inventory_products; Type: TABLE DATA; Schema: public; Owner: -
--

COPY public.inventory_products (id, name, description, price, quantity, min_alert, status, created_at, updated_at) FROM stdin;
1	Fonte ATX 12v 200w	\N	120.00	2	2	ativo	2025-12-01 22:40:31.280011	2026-02-01 01:27:22.989
\.


--
-- Data for Name: inventory_services; Type: TABLE DATA; Schema: public; Owner: -
--
...
99	1	quote_created	t	2026-01-22 21:45:08.009873	2026-01-22 21:45:08.009873
100	7	quote_created	t	2026-01-22 21:45:08.651428	2026-01-22 21:45:08.651428
101	5	quote_created	t	2026-01-22 21:45:09.020107	2026-01-22 21:45:09.020107
102	1	quote_updated	t	2026-01-22 21:46:00.321513	2026-01-22 21:46:00.321513
103	5	quote_updated	t	2026-01-22 21:46:01.065118	2026-01-22 21:46:01.065118
\.


--
-- Data for Name: preventive_maintenance; Type: TABLE DATA; Schema: public; Owner: -
--
...
592	Assessoria para resolver espelhamento de tela do notebook home office para monitor. \nInstalação de Pc novo na recepção. \n\nMonitor na assistência para analisar. 	\N	100.00	2 horas	Reparo	23	2026-01-22 12:26:16.369399	\N	2026-01-22 12:26:15.135	9	9	2026-01-21 13:42:30.332	309	media
...
597	Note na assistência para verificar lentidão. 	\N	100.00	2 horas	Reparo	184	2026-01-22 12:35:37.50276	\N	2026-01-22 12:35:36.268	9	9	2026-01-22 12:35:30.672	313	media
...
598	Manutenção preventiva e reinstalação de sistema operacional e atualizações	Manutenção preventiva e reinstalação de sistema operacional e atualizações	750.00	\N	orçamento	57	2026-01-22 21:48:01.635403	[{"name":"Instalação windows 11 pro + pacote de programas e atualizações","description":"Instalação windows 11 pro + pacote de programas e atualizações","type":"servico","unitPrice":150,"price":300,"amount":300,"quantity":2},{"name":"Manutenção preventiva com desoxidação dos contatos eletrônicos, substituição de pasta térmica do processador e bateria do CMOS","description":"Manutenção preventiva com desoxidação dos contatos eletrônicos, substituição de pasta térmica do processador e bateria do CMOS","type":"servico","unitPrice":75,"price":150,"amount":150,"quantity":2},{"name":"Licença Windows 11 pro original ativação via Hardware ID (licença atrelada ao hardware da máquina, ativação perpétua original Microsoft)","description":"Licença Windows 11 pro original ativação via Hardware ID (licença atrelada ao hardware da máquina, ativação perpétua original Microsoft)","type":"produto","unitPrice":150,"price":300,"amount":300,"quantity":2}]	2026-01-22 21:48:01.343	1	1	\N	\N	media
...
600	Visita técnica para verificar instalação da infra do apartamento novo. \nConjunto de máquinas para fazer manutenção e testes. 	\N	100.00	2 horas	Reparo	173	2026-01-27 23:52:21.328189	\N	2026-01-27 23:52:20.137	9	9	2025-12-18 20:18:29.922	267	media
601	Colocar bateria da CMOS em uma máquina. 	\N	100.00	2 horas	Reparo	103	2026-01-27 23:52:58.106212	\N	2026-01-27 23:52:56.912	9	9	2026-01-22 12:31:02.237	312	media
606	Reparo CPU antiga do balcão e Reparo na impressora Brother do caixa	CPU antiga do balcão necessita de fonte de alimentação. a fonte foi retirada e colocada no pc do caixa, no dia que fomos deixar a CPU na empresa.	849.00	\N	\N	41	2026-01-28 12:13:16.72529	[{"name":"Fonte ATX 12v 200W","description":"Fonte ATX 12v 200W","type":"produto","unitPrice":120,"price":120,"amount":120,"quantity":1},{"name":"Instalação da fonte de alimentação","description":"Instalação da fonte de alimentação","type":"servico","unitPrice":80,"price":80,"amount":80,"quantity":1},{"name":"Unidade fusora completa para impressora Brother DCP7065DN do caixa","description":"Unidade fusora completa para impressora Brother DCP7065DN do caixa","type":"produto","unitPrice":499,"price":499,"amount":499,"quantity":1},{"name":"Substituição da unidade de fusão e manutenção completa na impressora do caixa","description":"Substituição da unidade de fusão e manutenção completa na impressora do caixa","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1}]	2026-01-28 03:00:00	6	1	\N	\N	media
614	Impressora Brother não liga, provavelmente foi ligada em 220v	\N	100.00	2 horas	Reparo	127	2026-01-28 21:33:28.95417	\N	2026-01-29 00:33:27.716	7	7	2026-01-19 11:46:52.507	302	media
617	Pegar máquina para analisar	\N	530.00	2 horas	Reparo	133	2026-01-28 21:42:56.326316	[{"name":"Diagnóstico e resolução. Manutenção Desktop, limpeza interna, desoxidação das placas e troca da pasta térmica. Troca da Fonte de alimentação com organização dos cabos.","description":"Diagnóstico e resolução. Manutenção Desktop, limpeza interna, desoxidação das placas e troca da pasta térmica. Troca da Fonte de alimentação com organização dos cabos.","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Fonte de Alimentação 80 Plus Bronze Semi Modula ATX 24 Pinos","description":"Fonte de Alimentação 80 Plus Bronze Semi Modula ATX 24 Pinos","type":"produto","unitPrice":380,"price":380,"amount":380,"quantity":1}]	2026-01-29 00:42:54.815	9	9	2025-11-12 03:00:00	104	media
628	Pc lento	\N	320.00	2 horas	Reparo	186	2026-02-03 09:28:29.042699	[{"name":"Diagnóstico e resolução, limpeza interna, desoxidação das placas e troca da pasta térmica. Instalações Pente de memória RAM 4gb. Backup, formatação, instalações, configuração e atualização do windows 10 lite e pacote de programas, deixando pronto pra uso.","description":"Diagnóstico e resolução, limpeza interna, desoxidação das placas e troca da pasta térmica. Instalações Pente de memória RAM 4gb. Backup, formatação, instalações, configuração e atualização do windows 10 lite e pacote de programas, deixando pronto pra uso.","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Memória RAM Kingston DDR3 4G 2666GHz ( 1 Ano Garantia )","description":"Memória RAM Kingston DDR3 4G 2666GHz ( 1 Ano Garantia )","type":"produto","unitPrice":170,"price":170,"amount":170,"quantity":1}]	2026-02-03 12:28:28.347	9	9	2026-01-29 01:31:34.512	316	media
622	Odete ultrassom urgente	\N	351.00	\N	\N	8	2026-01-28 22:33:06.653087	[{"name":"Visita técnica de urgência para configurar e testar impressão DICOM.","description":"Visita técnica de urgência para configurar e testar impressão DICOM.","type":"servico","unitPrice":350,"price":350,"amount":350,"quantity":1},{"name":"Segunda visita técnica para fazer testes de comprovação junto ao médico. ","description":"Segunda visita técnica para fazer testes de comprovação junto ao médico. ","type":"servico","unitPrice":1,"price":1,"amount":1,"quantity":1}]	2026-01-28 03:00:00	9	9	\N	\N	media
632	Pegar note pra verificar tela. 	\N	100.00	2 horas	Reparo	130	2026-02-03 12:59:11.811855	\N	2026-02-03 15:59:10.822	9	9	2026-02-03 13:07:23.262	321	media
630	Note Luana	Pegar note para analisar webcam, se precisar trocar - Luana Reservas.	\N	\N	\N	56	2026-02-03 10:08:25.497478	\N	2026-02-03 03:00:00	9	9	\N	\N	media
631	Pc novo Zoraide	Pegar Pc com Célia e organizar pra Zoraide. 	\N	\N	\N	56	2026-02-03 10:08:50.770985	\N	2026-02-03 03:00:00	9	9	\N	\N	media
629	Verificar DVR e instalação de câmera nova.\nLevar câmeras, cartão de memória e fonte de alimentação.	\N	807.50	2 horas	Reparo	183	2026-02-03 09:28:40.696043	[{"name":"Visita técnica em Tibau para análise e execução. Troca da fonte de alimentação do DVR colocando uma fonte 12v5a. Instalação e configuração de câmeras smart, passagem de cabo até o DVR com alimentação e dados para a câmera smart. ","description":"Visita técnica em Tibau para análise e execução. Troca da fonte de alimentação do DVR colocando uma fonte 12v5a. Instalação e configuração de câmeras smart, passagem de cabo até o DVR com alimentação e dados para a câmera smart. ","type":"servico","unitPrice":300,"price":300,"amount":300,"quantity":1},{"name":"Câmera Smart IP Wi-fi/Lan Outdoor/Indoor ( 1 ano garantia )","description":"Câmera Smart IP Wi-fi/Lan Outdoor/Indoor ( 1 ano garantia )","type":"produto","unitPrice":250,"price":250,"amount":250,"quantity":1},{"name":"Suporte Infra Ativo P/ Fixar Câmera na cerca. ","description":"Suporte Infra Ativo P/ Fixar Câmera na cerca. ","type":"produto","unitPrice":75,"price":75,"amount":75,"quantity":1},{"name":"Cabo de rede CAT5.E  RJ45 100% Cobre.","description":"Cabo de rede CAT5.E  RJ45 100% Cobre.","type":"produto","unitPrice":3.65,"price":182.5,"amount":182.5,"quantity":50}]	2026-02-03 12:28:40.008	9	9	2026-01-20 16:07:09.956	308	media
635	Note Rômulo	Aumentar memória e fazer geral. 	\N	\N	\N	46	2026-02-04 10:41:33.65631	\N	2026-02-04 03:00:00	9	9	\N	\N	media
636	Popo bateria note	Quando for levar note e monitor. 	\N	\N	\N	176	2026-02-04 10:42:02.225623	\N	2026-02-04 03:00:00	9	9	\N	\N	media
637	Reparo dobradiça e tela 	\N	600.00	\N	\N	130	2026-02-04 11:11:16.49385	[{"name":"Serviço notebook, troca da tela, reparo na carcaça/moldura, manutenção e lubrificação nas dobradiças evitando que quebre a tela e carcaça novamante.","description":"Serviço notebook, troca da tela, reparo na carcaça/moldura, manutenção e lubrificação nas dobradiças evitando que quebre a tela e carcaça novamante.","type":"servico","unitPrice":150,"price":150,"amount":150,"quantity":1},{"name":"Tela P/ Notebook Acer, tela com bordas 15.6 HD. ( 6 meses garantia )","description":"Tela P/ Notebook Acer, tela com bordas 15.6 HD. ( 6 meses garantia )","type":"produto","unitPrice":450,"price":450,"amount":450,"quantity":1}]	2026-02-04 03:00:00	9	9	\N	\N	media
\.


--
-- Data for Name: signature_attempts; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: signature_audit_log; Type: TABLE DATA; Schema: public; Owner: -
--
...
--
-- Data for Name: system_activation; Type: TABLE DATA; Schema: public; Owner: -
--
...
8	Apoiotec1@Informatica	ca8ba749fd8c28ec9b3ce7b889c9443e7395544596d613c72083bca7794c8ea6	0	\N	2026-01-28 16:22:49.260594	\N
\.
...
--
-- Data for Name: telegram_config; Type: TABLE DATA; Schema: public; Owner: -
--
...
20211116024918	2026-01-20 17:28:56
20211116045059	2026-01-20 17:28:57
20211116050929	2026-01-20 17:28:57
20211116051442	2026-01-20 17:28:57
20211116212300	2026-01-20 17:28:57
20211116213355	2026-01-20 18:36:22
20211116213934	2026-01-20 18:36:22
20211116214523	2026-01-20 18:36:23
20211122062447	2026-01-20 18:36:23
20211124070109	2026-01-20 18:36:23
20211202204204	2026-01-20 18:36:23
20211202204605	2026-01-20 18:36:23
20211210212804	2026-01-20 18:36:24
20211228014915	2026-01-20 18:36:24
20220107221237	2026-01-20 18:36:25
20220228202821	2026-01-20 18:36:25
20220312004840	2026-01-20 18:36:25
20220603231003	2026-01-20 18:36:25
20220603232444	2026-01-20 18:36:25
20220615214548	2026-01-20 18:36:26
20220712093339	2026-01-20 18:36:26
20220908172859	2026-01-20 18:36:26
20220916233421	2026-01-20 18:36:26
20230119133233	2026-01-20 18:36:26
20230128025114	2026-01-20 18:36:27
20230128025212	2026-01-20 18:36:27
20230227211149	2026-01-20 18:36:27
20230228184745	2026-01-20 18:36:27
20230308225145	2026-01-20 18:36:28
20230328144023	2026-01-20 18:36:28
20231018144023	2026-01-20 18:36:28
20231204144023	2026-01-20 18:36:28
20231204144024	2026-01-20 18:36:28
20231204144025	2026-01-20 18:36:29
20240108234812	2026-01-20 18:36:29
20240109165339	2026-01-20 18:36:29
20240227174441	2026-01-20 18:36:29
20240311171622	2026-01-20 18:36:30
20240321100241	2026-01-20 18:36:30
20240401105812	2026-01-20 18:36:31
20240418121054	2026-01-20 18:36:31
20240523004032	2026-01-20 18:36:32
20240618124746	2026-01-20 18:36:32
20240801235015	2026-01-20 18:36:32
20240805133720	2026-01-20 18:36:32
20240827160934	2026-01-20 18:36:32
20240919163303	2026-01-20 18:36:33
20240919163305	2026-01-20 18:36:33
20241019105805	2026-01-20 18:36:33
20241030150047	2026-01-20 18:36:34
20241108114728	2026-01-20 18:36:34
20241121104152	2026-01-20 18:36:34
20241130184212	2026-01-20 18:36:34
20241220035512	2026-01-20 18:36:35
20241220123912	2026-01-20 18:36:35
20241224161212	2026-01-20 18:36:35
20250107150512	2026-01-20 18:36:35
20250110162412	2026-01-20 18:36:35
20250123174212	2026-01-20 18:36:36
20250128220012	2026-01-20 18:36:36
20250506224012	2026-01-20 18:36:36
20250523164012	2026-01-20 18:36:36
20250714121412	2026-01-20 18:36:36
20250905041441	2026-01-20 18:36:37
20251103001201	2026-01-20 18:36:37
20251120212548	2026-02-03 20:37:27
20251120215549	2026-02-03 20:37:28
\.
...
0	create-migrations-table	e18db593bcde2aca2a408c4d1100f6abba2195df	2026-01-20 17:29:37.555428
1	initialmigration	6ab16121fbaa08bbd11b712d05f358f9b555d777	2026-01-20 17:29:37.6031
2	storage-schema	5c7968fd083fcea04050c1b7f6253c9771b99011	2026-01-20 17:29:37.623121
3	pathtoken-column	2cb1b0004b817b29d5b0a971af16bafeede4b70d	2026-01-20 17:29:37.65257
4	add-migrations-rls	427c5b63fe1c5937495d9c635c263ee7a5905058	2026-01-20 17:29:37.665397
5	add-size-functions	79e081a1455b63666c1294a440f8ad4b1e6a7f84	2026-01-20 17:29:37.670367
6	change-column-name-in-get-size	f93f62afdf6613ee5e7e815b30d02dc990201044	2026-01-20 17:29:37.67648
7	add-rls-to-buckets	e7e7f86adbc51049f341dfe8d30256c1abca17aa	2026-01-20 17:29:37.683489
8	add-public-to-buckets	fd670db39ed65f9d08b01db09d6202503ca2bab3	2026-01-20 17:29:37.688444
9	fix-search-function	3a0af29f42e35a4d101c259ed955b67e1bee6825	2026-01-20 17:29:37.693286
10	search-files-search-function	68dc14822daad0ffac3746a502234f486182ef6e	2026-01-20 17:29:37.698577
11	add-trigger-to-auto-update-updated_at-column	7425bdb14366d1739fa8a18c83100636d74dcaa2	2026-01-20 17:29:37.70399
12	add-automatic-avif-detection-flag	8e92e1266eb29518b6a4c5313ab8f29dd0d08df9	2026-01-20 17:29:37.709494
13	add-bucket-custom-limits	cce962054138135cd9a8c4bcd531598684b25e7d	2026-01-20 17:29:37.714357
14	use-bytes-for-max-size	941c41b346f9802b411f06f30e972ad4744dad27	2026-01-20 17:29:37.720811
15	add-can-insert-object-function	934146bc38ead475f4ef4b555c524ee5d66799e5	2026-01-20 17:29:37.747207
16	add-version	76debf38d3fd07dcfc747ca49096457d95b1221b	2026-01-20 17:29:37.752529
17	drop-owner-foreign-key	f1cbb288f1b7a4c1eb8c38504b80ae2a0153d101	2026-01-20 17:29:37.757609
18	add_owner_id_column_deprecate_owner	e7a511b379110b08e2f214be852c35414749fe66	2026-01-20 17:29:37.762725
19	alter-default-value-objects-id	02e5e22a78626187e00d173dc45f58fa66a4f043	2026-01-20 17:29:37.770239
20	list-objects-with-delimiter	cd694ae708e51ba82bf012bba00caf4f3b6393b7	2026-01-20 17:29:37.775571
21	s3-multipart-uploads	8c804d4a566c40cd1e4cc5b3725a664a9303657f	2026-01-20 17:29:37.782471
22	s3-multipart-uploads-big-ints	9737dc258d2397953c9953d9b86920b8be0cdb73	2026-01-20 17:29:37.796645
23	optimize-search-function	9d7e604cddc4b56a5422dc68c9313f4a1b6f132c	2026-01-20 17:29:37.806685
24	operation-function	8312e37c2bf9e76bbe841aa5fda889206d2bf8aa	2026-01-20 17:29:37.811614
25	custom-metadata	d974c6057c3db1c1f847afa0e291e6165693b990	2026-01-20 17:29:37.816401
26	objects-prefixes	ef3f7871121cdc47a65308e6702519e853422ae2	2026-01-20 17:29:37.821281
27	search-v2	33b8f2a7ae53105f028e13e9fcda9dc4f356b4a2	2026-01-20 17:29:37.833445
28	object-bucket-name-sorting	ba85ec41b62c6a30a3f136788227ee47f311c436	2026-01-20 17:29:38.668317
29	create-prefixes	a7b1a22c0dc3ab630e3055bfec7ce7d2045c5b7b	2026-01-20 17:29:38.676101
30	update-object-levels	6c6f6cc9430d570f26284a24cf7b210599032db7	2026-01-20 17:29:38.682741
31	objects-level-index	33f1fef7ec7fea08bb892222f4f0f5d79bab5eb8	2026-01-20 17:29:38.690165
32	backward-compatible-index-on-objects	2d51eeb437a96868b36fcdfb1ddefdf13bef1647	2026-01-20 17:29:38.697488
33	backward-compatible-index-on-prefixes	fe473390e1b8c407434c0e470655945b110507bf	2026-01-20 17:29:38.705096
34	optimize-search-function-v1	82b0e469a00e8ebce495e29bfa70a0797f7ebd2c	2026-01-20 17:29:38.707172
35	add-insert-trigger-prefixes	63bb9fd05deb3dc5e9fa66c83e82b152f0caf589	2026-01-20 17:29:38.713303
36	optimise-existing-functions	81cf92eb0c36612865a18016a38496c530443899	2026-01-20 17:29:38.717878
37	add-bucket-name-length-trigger	3944135b4e3e8b22d6d4cbb568fe3b0b51df15c1	2026-01-20 17:29:38.725592
38	iceberg-catalog-flag-on-buckets	19a8bd89d5dfa69af7f222a46c726b7c41e462c5	2026-01-20 17:29:38.73087
39	add-search-v2-sort-support	39cf7d1e6bf515f4b02e41237aba845a7b492853	2026-01-20 17:29:38.742708
40	fix-prefix-race-conditions-optimized	fd02297e1c67df25a9fc110bf8c8a9af7fb06d1f	2026-01-20 17:29:38.748994
41	add-object-level-update-trigger	44c22478bf01744b2129efc480cd2edc9a7d60e9	2026-01-20 17:29:38.759013
42	rollback-prefix-triggers	f2ab4f526ab7f979541082992593938c05ee4b47	2026-01-20 17:29:38.765046
43	fix-object-level	ab837ad8f1c7d00cc0b7310e989a23388ff29fc6	2026-01-20 17:29:38.771362
44	vector-bucket-type	99c20c0ffd52bb1ff1f32fb992f3b351e3ef8fb3	2026-01-20 17:29:38.77637
45	vector-buckets	049e27196d77a7cb76497a85afae669d8b230953	2026-01-20 17:29:38.78189
46	buckets-objects-grants	fedeb96d60fefd8e02ab3ded9fbde05632f84aed	2026-01-20 17:29:38.795186
47	iceberg-table-metadata	649df56855c24d8b36dd4cc1aeb8251aa9ad42c2	2026-01-20 17:29:38.801193
48	iceberg-catalog-ids	2666dff93346e5d04e0a878416be1d5fec345d6f	2026-01-20 17:29:38.805831
49	buckets-objects-grants-postgres	072b1195d0d5a2f888af6b2302a1938dd94b8b3d	2026-01-20 17:29:38.822241
\.
...
--
-- Name: backup_execution_logs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.backup_execution_logs_id_seq', 48, true);
...
SELECT pg_catalog.setval('public.backup_history_id_seq', 77, true);
...
SELECT pg_catalog.setval('public.calls_id_seq', 323, true);
...
SELECT pg_catalog.setval('public.clients_id_seq', 187, true);


--
-- Name: digital_certificates_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: download_links_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.financial_transactions_id_seq', 1321, true);


--
-- Name: history_events_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.history_events_id_seq', 1893, true);
...
SELECT pg_catalog.setval('public.inventory_movements_id_seq', 33, true);


--
-- Name: inventory_products_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: inventory_services_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.notification_preferences_id_seq', 103, true);


--
-- Name: preventive_maintenance_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
SELECT pg_catalog.setval('public.quotes_id_seq', 100, true);
...
SELECT pg_catalog.setval('public.services_id_seq', 637, true);


--
-- Name: signature_attempts_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: signature_audit_log_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: system_activation_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--

SELECT pg_catalog.setval('public.system_activation_id_seq', 8, true);
...
--
-- Name: telegram_config_id_seq; Type: SEQUENCE SET; Schema: public; Owner: -
--
...
--
-- Name: backup_execution_logs backup_execution_logs_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: digital_certificates digital_certificates_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: download_links download_links_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: history_events history_events_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: inventory_services inventory_services_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: preventive_maintenance preventive_maintenance_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: signature_attempts signature_attempts_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: system_activation system_activation_hardware_fingerprint_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: system_activation system_activation_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict uWAP5hXBiYawsWQ1oJqAvRygmAUjyibUqvPRwqb7WDlqfj19MntE1WpsLHx5GDc
